...
window.RuntimeInterface = class a {
    ...
    _GetWorkerURL(b) {
        b = this._workerScriptURLs.hasOwnProperty(b) ? this._workerScriptURLs[b] : b.endsWith("/workermain.js") && this._workerScriptURLs.hasOwnProperty("workermain.js") ? this._workerScriptURLs["workermain.js"] : "playable-ad" === this._exportType && this._localFileBlobs.hasOwnProperty(b.toLowerCase()) ? this._localFileBlobs[b.toLowerCase()] : b;
        ...
        if ("cordova" === this._exportType)
            for (let g = 0, h = b.projectScripts.length; g < h; ++g) {
                const k = b.projectScripts[g]
                  , l = k[0];
                if (l === b.mainProjectScript || "scriptsInEvents.js" === l || l.endsWith("/scriptsInEvents.js"))
    ...
    *audioInstancesByTag(a) {
    ...
    async _Play(a) {
        const b = a.originalUrl
          ...
          , l = a.panning;
        let m = a.off;
        0 < m && !a.trueClock && (this._audioContext.getOutputTimestamp ? (a = this._audioContext.getOutputTimestamp(),
        m = m - a.performanceTime / 1E3 + a.contextTime) : m = m - performance.now() / 1E3 + this._audioContext.currentTime);
        ...
        try {
            ...
            l.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(l.uid)) : this._lastAudioInstance.SetPannerEnabled(!1),
...
self.C3AudioInstance = class {
    ...
    SetPanXYA(a, b, c) {
        this._isPannerEnabled && (this._pannerPosition[0] = a,
...
self.RuntimeInterface.AddDOMHandlerClass(class extends self.DOMHandler {
    ...
    _OnExitFullscreen() {
        "windows-webview2" === this._exportType || "macos-wkwebview" === this._exportType ? (self.RuntimeInterface._SetWrapperIsFullscreenFlag(!1),
        this._iRuntime._SendWrapperMessage({
            type: "set-fullscreen",
            fullscreen: !1
...
self.RuntimeInterface.AddDOMHandlerClass(class extends self.DOMHandler {
    ...
    _GetActiveGamepads() {
        try {
            ...
            return didLogGetGamepadsError || (console.warn("[Construct] Failed to access gamepads: ", a),
            didLogGetGamepadsError = !0),
            []
        }
    }
    ...
    async _OnGamepadVibrate(a) {
        ...
        if (b && (b = b.vibrationActuator) && b.playEffect)
            try {
