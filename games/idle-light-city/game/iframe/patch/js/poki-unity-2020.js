...
, function(n, e, t) {
            ...
            return x.a.wrap(function(n) {
                for (; ; )
                    ...
                    case 16:
                        ...
                        i = 0; i <= S.a.numScreenshots - 1; i++)
                            o = document.createElement("div"),
                            o.className = "bullet".concat(0 === i ? " active" : ""),
            ...
            return x.a.wrap(function(n) {
                for (; ; )
                    ...
                    case 0:
                        ...
                        return o = Date.now(),
                        n.next = 7,
                        f("".concat(B, "screenshots/").concat(i + 1, ".jpg").concat(I));
                    case 7:
                        r = n.sent,
                        t.querySelector("img").src = r.src,
                        t.setAttribute("fullImageLoaded", !0),
    ...
    e.a = r;
    var m, p, g, w, v, y, b = t(10), x = t.n(b), S = t(0), L = "image", k = 0, E = !1, I = S.a.screenshotsVersion ? "?v".concat(S.a.screenshotsVersion) : "", T = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/")), C = window.location.hostname.endsWith("game-cdn.poki.com") || window.location.hostname.endsWith(".poki-gdn.com"), B = C ? "/cdn-cgi/image/f=auto,quality=78".concat(T, "/") : "";
    ...
    n.exports = function(n) {
        ...
        e.i = function(n, t) {
            ...
            for (o = 0; o < n.length; o++) {
                var a = n[o];
                null != a[0] && i[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = "(" + a[2] + ") and (" + t + ")"),
                e.push(a))
            }
        }
        ,
...
, function(n, e, t) {
    ...
    function r(n, e) {
        ...
        var i = x[x.length - 1];
        if ("top" === n.insertAt)
            i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild),
            x.push(e);
    ...
    n.exports = function(n) {
        ...
        return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, e) {
            ...
            if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o))
                return n;
            var r;
            return r = 0 === o.indexOf("//") ? o : 0 === o.indexOf("/") ? t + o : i + o.replace(/^\.\//, ""),
...
, function(n, e, t) {
    ...
    function i() {
        ...
        d.style.marginLeft = "".concat(-.5 * i.width, "px"),
        d.style.marginTop = "".concat(-.5 * i.height, "px")
    }
    function o() {
...
, function(n, e, t) {
    var i = function(n) {
        ...
        return o.prototype = j.constructor = r,
        r.constructor = o,
