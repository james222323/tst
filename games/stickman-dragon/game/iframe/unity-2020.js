...
, function(n, e, t) {
                ...
                for (; ; )
                    ...
                    case 31:
                        ...
                        a = function(n) {
                            ...
                            1 === n ? e.className = "".concat(k, " right") : n === S.a.numScreenshots - 1 ? e.className = "".concat(k, " left") : e.className = "".concat(k, " inactive"),
                            w.appendChild(e)
                        }
                        ,
    ...
    function d(n) {
        L = n << 0;
        var e = L > 0 ? L - 1 : S.a.numScreenshots - 1
          , t = L < S.a.numScreenshots - 1 ? L + 1 : 0;
        w.querySelectorAll(".image").forEach(function(n) {
            n.className === "".concat(k, " left") && (n.className = "".concat(k, " fromLeft")),
            n.className === "".concat(k, " right") && (n.className = "".concat(k, " fromRight")),
            -1 === n.className.indexOf("inactive") && (n.className += " inactive")
        }),
        w.querySelector('[data-idx="'.concat(L, '"]')).className = "".concat(k, " middle"),
        w.querySelector('[data-idx="'.concat(e, '"]')).className = "".concat(k, " left"),
        w.querySelector('[data-idx="'.concat(t, '"]')).className = "".concat(k, " right"),
        ...
        window.slideShowMoveTransitionID = window.setTimeout(function() {
            w.querySelectorAll(".inactive").forEach(function(n) {
                n.className = "".concat(k, " inactive fromRight")
            })
    ...
    e.a = r;
    var m, p, g, w, v, y, b = t(10), x = t.n(b), S = t(0), k = "image", L = 0, E = !1, I = S.a.screenshotsVersion ? "?v".concat(S.a.screenshotsVersion) : "", T = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/")), C = window.location.hostname.endsWith("game-cdn.poki.com") || window.location.hostname.endsWith(".poki-gdn.com"), B = C ? "/cdn-cgi/image/f=auto,quality=78".concat(T, "/") : "";
...
, function(n, e, t) {
    ...
    d.title = r.a.title;
    var u = r.a.thumbnail;
    u.startsWith("https://img.poki.com/") && (u = "https://img.poki.com/cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/".concat(u.substr(21))),
    d.src = u;
    var f = o("slideshow-top-container")
      , h = o("game-title");
    h.innerText = r.a.title;
    var m = o("progress-spinner");
    m.innerHTML = '<div class="bounce0"></div><div class="bounce1"></div><div class="bounce2">',
    m.setAttribute("class", "spinner");
    var p = o("progress-container")
      , g = o("progress-bar")
      , w = o("progress-fill");
    w.style.width = "0%";
    var v = o("progress-amount");
    v.innerText = "0%";
    var y = o("progress-comment");
    y.innerText = "Loading";
    var b = o("slideshow-images")
      , x = o("slideshow-nav")
      , S = o("game-container")
      , k = document.createElement("canvas");
    k.setAttribute("id", "game"),
    s.appendChild(c),
    c.appendChild(l),
    c.appendChild(b),
    c.appendChild(x),
...
, function(n, e, t) {
    ...
    function a(n) {
        ...
        n >= 1 && "done" !== f.className && (f.className = "done",
...
, function(n, e, t) {
    var o = function(n) {
        ...
        var j = r.prototype = o.prototype = Object.create(T);
