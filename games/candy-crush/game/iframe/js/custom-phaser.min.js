...
(function() {
    ...
    function e(e, i, s, r, o) {
        ...
        u = t(e, i, s, r),
        e.framebufferTexture2D(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, u, 0),
        (l = e.checkFramebufferStatus(e.FRAMEBUFFER)) !== e.FRAMEBUFFER_COMPLETE && console.error("Incomplete GL framebuffer. ", n[l]),
        a.width = i,
        a.height = s,
        a.targetTexture = u,
        a.renderBuffer = h,
    ...
    s.DisplayObject.prototype = {
        ...
        updateTransform: function(t) {
            ...
            var i, s, n, r, o, a, h = e.worldTransform, u = this.worldTransform;
            ...
            u.c = n * h.a + r * h.c,
            u.d = n * h.b + r * h.d,
            u.tx = o * h.a + a * h.c + h.tx,
            u.ty = o * h.b + a * h.d + h.ty) : (i = this.scale.x,
            s = 0,
            n = 0,
            r = this.scale.y,
            ...
            if (i || s) {
                ...
                this.worldRotation = s > 0 ? Math.acos(i / c) : -Math.acos(i / c),
                this.worldScale.x = c,
                this.worldScale.y = l / c
            } else if (n || r) {
                var d = Math.sqrt(n * n + r * r);
                this.worldRotation = Phaser.Math.HALF_PI - (r > 0 ? Math.acos(-n / d) : -Math.acos(n / d)),
                this.worldScale.x = l / d,
                this.worldScale.y = d
            } else
                this.worldScale.x = 0,
                this.worldScale.y = 0;
            return this.worldAlpha = this.alpha * e.worldAlpha,
            this.worldPosition.x = u.tx,
            this.worldPosition.y = u.ty,
            this._currentBounds = null,
            this.transformCallback && this.transformCallback.call(this.transformCallbackContext, u, h),
            this
        },
        preUpdate: function() {},
        generateTexture: function(t, e, i) {
            ...
            r.render(this, s.DisplayObject._tempMatrix),
            r
        },
        ...
        _generateCachedSprite: function() {
            ...
            this._cachedSprite)
                ...
                this._cachedSprite = new s.Sprite(i),
            ...
            set: function(t) {
                if (Array.isArray(t)) {
                    for (var e = [], i = 0; i < t.length; i++)
                        for (var n = t[i].passes, r = 0; r < n.length; r++)
                            e.push(n[r]);
                    this._filterBlock = {
                        target: this,
                        filterPasses: e
    ...
    s.DisplayObjectContainer.prototype.getBounds = function(t) {
        ...
        if (e) {
            ...
            for (t.worldTransform = Phaser.identityMatrix,
            n = 0; n < t.children.length; n++)
                t.children[n].updateTransform()
        }
        var o, a, h, u = 1 / 0, l = 1 / 0, c = -1 / 0, d = -1 / 0, p = !1;
        for (n = 0; n < this.children.length; n++)
            this.children[n].visible && (p = !0,
            u = u < (o = this.children[n].getBounds()).x ? u : o.x,
            l = l < o.y ? l : o.y,
            a = o.width + o.x,
            h = o.height + o.y,
            c = c > a ? c : a,
        ...
        if (!p) {
            ...
            d = E,
            l = E,
            u = I < (u = R < (u = A < (u = P) ? A : u) ? R : u) ? I : u,
            l = L < (l = O < (l = M < l ? M : l) ? O : l) ? L : l,
            c = I > (c = R > (c = A > c ? A : c) ? R : c) ? I : c,
            d = L > (d = O > (d = M > d ? M : d) ? O : d) ? L : d
        }
        if (f.x = u,
        f.y = l,
        f.width = c - u,
    ...
    s.Sprite = function(t) {
        ...
        this.anchor = new s.Point(s.Sprite.defaultAnchor.x,s.Sprite.defaultAnchor.y),
    ...
    s.Sprite.prototype.getBounds = function(t) {
        ...
        if (0 === u && 0 === l) {
            ...
            var x = h * n + l * o + d
              ...
              , S = h * n + l * r + d
              , P = c * r + u * n + p;
            m = S < (m = w < (m = b < (m = x < m ? x : m) ? b : m) ? w : m) ? S : m,
            y = P < (y = C < (y = T < (y = _ < y ? _ : y) ? T : y) ? C : y) ? P : y,
            f = S > (f = w > (f = b > (f = x > f ? x : f) ? b : f) ? w : f) ? S : f,
            g = P > (g = C > (g = T > (g = _ > g ? _ : g) ? T : g) ? C : g) ? P : g
        }
        var E = this._bounds;
        return E.x = m,
        E.width = f - m,
        ...
        if (!(!this.visible || 0 === this.alpha || !this.renderable || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            this.texture.valid) {
                ...
                if (this.texture.rotated) {
                    ...
                    a = i.c * l + a,
                    h = i.d * l + h,
                    i.a = 6.123233995736766e-17 * c - p,
                    i.b = 6.123233995736766e-17 * d - f,
                    i.c = c + 6.123233995736766e-17 * p,
                    i.d = d + 6.123233995736766e-17 * f,
                    u = l,
                    l = g
                }
                if (t.roundPixels ? (t.context.setTransform(i.a, i.b, i.c, i.d, 0 | a, 0 | h),
                r |= 0,
                o |= 0) : t.context.setTransform(i.a, i.b, i.c, i.d, a, h),
                r /= n,
                o /= n,
                16777215 !== this.tint)
                    ...
                    t.context.drawImage(this.tintedTexture, 0, 0, u, l, r, o, u / n, l / n);
                else {
                    var m = this.texture.crop.x
                      , y = this.texture.crop.y;
                    u = Math.floor(u),
                    l = Math.floor(l),
                    t.context.drawImage(this.texture.baseTexture.source, m, y, u, l, r, o, u / n, l / n)
                }
                for (v = 0; v < this.children.length; v++)
                    this.children[v]._renderCanvas(t);
                this._mask && t.maskManager.popMask(t)
            } else {
    ...
    s.PixiShader.prototype.initMultitexShader = function() {
        var t = this.gl;
        ...
        for (var e = "\tif (vTextureIndex == 0.0) { gl_FragColor = texture2D(uSamplerArray[0], vTextureCoord) * vColor;return;}\n", i = 1; i < this.MAX_TEXTURES; ++i)
            e += "\tif (vTextureIndex == " + i + ".0) {gl_FragColor = texture2D(uSamplerArray[" + i + "], vTextureCoord) * vColor;return;}\n";
        ...
        for (var a = 0; a < this.MAX_TEXTURES; ++a)
            ...
            r.push(a);
        t.activeTexture(t.TEXTURE0),
        t.uniform1iv(this.uSamplerArray, r),
    ...
    s.PixiFastShader.prototype.init = function() {
        ...
        if (t.useProgram(e),
        this.uSampler = s._enableMultiTextureToggle ? t.getUniformLocation(e, "uSamplerArray[0]") : t.getUniformLocation(e, "uSampler"),
        s._enableMultiTextureToggle) {
            var i = []
              , n = t.createTexture();
            t.activeTexture(t.TEXTURE0),
            ...
            t.texImage2D(t.TEXTURE_2D, 0, t.RGB, 1, 1, 0, t.RGB, t.UNSIGNED_BYTE, null);
            for (var r = 0; r < this.MAX_TEXTURES; ++r)
    ...
    s.StripShader = function(t) {
        ...
        s._enableMultiTextureToggle) {
            ...
            for (var e = "\tif (vTextureIndex == 0.0) { gl_FragColor = texture2D(uSamplerArray[0], vTextureCoord);return;}\n", i = 1; i < this.MAX_TEXTURES; ++i)
                e += "\tif (vTextureIndex == " + i + ".0) { gl_FragColor = texture2D(uSamplerArray[" + i + "], vTextureCoord) ;return;}\n";
    ...
    s.glContexts = [],
    s.instances = [],
    s._enableMultiTextureToggle = !1,
    s.WebGLRenderer = function(t, e) {
        this.game = t,
        ...
        this.spriteBatch = new s.WebGLSpriteBatch(t),
    ...
    s.WebGLRenderer.prototype.initContext = function() {
        ...
        i && (this.extensions.compression.PVRTC = i),
    ...
    s.WebGLRenderer.prototype.setTexturePriority = function(t) {
        if (s._enableMultiTextureToggle) {
            for (var e = function(t) {
                ...
                t |= t >> 16,
                ++t
            }, i = this.gl, n = i.getParameter(i.MAX_TEXTURE_IMAGE_UNITS), r = i.getParameter(i.MAX_TEXTURE_SIZE), o = this.game.cache._cache.image, a = null, h = 0; h < this.currentBatchedTextures.length; h++)
                (a = this.currentBatchedTextures[h])in o ? o[a].base.textureIndex = 0 : console.warn('setTexturePriority: There is no image "%s" in the image cache.', a);
            var u = r - e(Math.max(this.width, this.height));
            this.currentBatchedTextures.length = 0;
            for (var l = 0; l < t.length; ++l)
                if ((a = t[l])in o) {
                    var c = o[a].base;
                    (u -= e(Math.max(c.width, c.height))) <= 0 ? (c.textureIndex = 0,
                    console.warn('setTexturePriority: Image "%s" was given textureIndex=0 because there is no available texture space (%s).', a, u)) : c.textureIndex = 1 + l % (n - 1),
                    this.currentBatchedTextures.push(a)
                } else
                    console.warn('setTexturePriority: There is no image "%s" in the image cache.', a);
            return this.renderSession.maxTextureAvailableSpace = u,
            this.currentBatchedTextures
        }
    ...
    s.WebGLRenderer.prototype.updateCompressedTexture = function(t) {
        ...
        t.mipmap && Phaser.Math.isPowerOfTwo(t.width, t.height) ? (e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, t.scaleMode === s.scaleModes.LINEAR ? e.LINEAR_MIPMAP_LINEAR : e.NEAREST_MIPMAP_NEAREST),
    ...
    s.WebGLStencilManager.prototype.bindGraphics = function(t, e, i) {
        ...
        n.vertexAttribPointer(s.aVertexPosition, 2, n.FLOAT, !1, 8, 0),
        n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, e.indexBuffer)) : (s = i.shaderManager.primitiveShader,
        i.shaderManager.setShader(s),
        n.uniformMatrix3fv(s.translationMatrix, !1, t.worldTransform.toArray(!0)),
        n.uniform1f(s.flipY, i.flipY),
        n.uniform2f(s.projectionVector, r.x, -r.y),
    ...
    s.WebGLShaderManager.prototype.setContext = function(t) {
        ...
        this.creatureShader = s.CreatureShader ? new s.CreatureShader(t) : null,
    ...
    s.WebGLSpriteBatch.prototype.render = function(t, e) {
        var i = t.texture
          , n = i.baseTexture
          , r = this.gl;
        s.WebGLRenderer.textureArray[n.textureIndex] != n && (this.flush(),
        r.activeTexture(r.TEXTURE0 + n.textureIndex),
        r.bindTexture(r.TEXTURE_2D, n._glTextures[r.id]),
        s.WebGLRenderer.textureArray[n.textureIndex] = n);
        ...
        var a = i._uvs;
        if (a) {
            var h, u, l, c, d = t.anchor.x, p = t.anchor.y;
            if (i.trim) {
                var f = i.trim;
                h = (u = f.x - d * f.width) + i.crop.width,
                l = (c = f.y - p * f.height) + i.crop.height
            } else
                h = i.frame.width * (1 - d),
                u = i.frame.width * -d,
                l = i.frame.height * (1 - p),
                c = i.frame.height * -p;
            ...
            if (i.rotated) {
                ...
                T = o.c * C + T,
                w = o.d * C + w,
                v = 6.123233995736766e-17 * S - E,
                x = 6.123233995736766e-17 * P - A,
                _ = S + 6.123233995736766e-17 * E,
                b = P + 6.123233995736766e-17 * A,
            ...
            this.renderSession.roundPixels ? (I[g++] = v * u + _ * c + T | 0,
            I[g++] = b * c + x * u + w | 0,
            I[g++] = a.x0,
            I[g++] = a.y0,
            O[g++] = D,
    ...
    s.WebGLSpriteBatch.prototype.renderTilingSprite = function(t) {
        ...
        s.WebGLRenderer.textureArray[r] != i && (this.flush(),
        n.activeTexture(n.TEXTURE0 + r),
        n.bindTexture(n.TEXTURE_2D, i._glTextures[n.id]),
        s.WebGLRenderer.textureArray[r] = i),
        this.currentBatchSize >= this.size && (this.flush(),
    ...
    s.WebGLSpriteBatch.prototype.flush = function() {
        if (0 !== this.currentBatchSize) {
            ...
            for (var r, o, a, h, u = 0, l = 0, c = null, d = this.renderSession.blendModeManager.currentBlendMode, p = null, f = !1, g = !1, m = 0, y = this.currentBatchSize; m < y; m++) {
                ...
                g)) {
                    (t = (p = a).shaders[e.id]) || ((t = new s.PixiShader(e)).fragmentSrc = p.fragmentSrc,
    ...
    s.WebGLFastSpriteBatch.prototype.renderSprite = function(t) {
        ...
        if ((s.WebGLRenderer.textureArray[n] == e || !e._glTextures[i.id] || t.texture.baseTexture.skipRender || (this.flush(),
        i.activeTexture(i.TEXTURE0 + n),
        i.bindTexture(i.TEXTURE_2D, e._glTextures[i.id]),
        s.WebGLRenderer.textureArray[n] = e,
        t.texture._uvs)) && t.visible) {
            ...
            t.texture.trim) {
                ...
                o = (a = d.x - t.anchor.x * d.width) + t.texture.crop.width,
                h = (u = d.y - t.anchor.y * d.height) + t.texture.crop.height
            } else
                o = t.texture.frame.width * (1 - t.anchor.x),
                a = t.texture.frame.width * -t.anchor.x,
                h = t.texture.frame.height * (1 - t.anchor.y),
                u = t.texture.frame.height * -t.anchor.y;
    ...
    s.WebGLFilterManager.prototype.popFilter = function() {
        ...
        this.vertexArray[2] = x + i.width,
        this.vertexArray[3] = _ + i.height,
        this.vertexArray[4] = x,
        this.vertexArray[5] = _,
        this.vertexArray[6] = x + i.width,
    ...
    s.WebGLFilterManager.prototype.applyFilterPass = function(t, e, i, n) {
        var r = this.gl
          , o = t.shaders[r.id];
        o || ((o = new s.PixiShader(r)).fragmentSrc = t.fragmentSrc,
        o.uniforms = t.uniforms,
        o.init(!0),
        t.shaders[r.id] = o),
        this.renderSession.shaderManager.setShader(o),
        r.uniform2f(o.projectionVector, i / 2, -n / 2),
    ...
    return s.FilterTexture = function(t, i, n, r, o) {
        ...
        this.gl = t,
        this.frameBuffer = e(t, i, n, r || s.scaleModes.DEFAULT, o),
    ...
    s.CanvasTinter.tintWithPerPixel = function(t, e, i) {
        ...
        t.rotated && (o = a,
        a = r.width),
        i.width === o && i.height === a || (i.width = o,
        i.height = a),
    ...
    ,
    s.CanvasRenderer.prototype.setTexturePriority = function(t) {}
    ,
    ...
    exports.PIXI = s) : "undefined" != typeof define && define.amd ? define("PIXI", i.PIXI = s) : i.PIXI = s,
    s
}
).call(this),
function() {
    ...
    i.Utils = {
        ...
        extend: function() {
            var t, e, s, n, r, o, a = arguments[0] || {}, h = 1, u = arguments.length, l = !1;
            ...
            --h); h < u; h++)
                if (null != (t = arguments[h]))
                    for (e in t)
                        s = a[e],
                        a !== (n = t[e]) && (l && n && (i.Utils.isPlainObject(n) || (r = Array.isArray(n))) ? (r ? (r = !1,
                        o = s && Array.isArray(s) ? s : []) : o = s && i.Utils.isPlainObject(s) ? s : {},
                        a[e] = i.Utils.extend(l, o, n)) : void 0 !== n && (a[e] = n));
            return a
        },
    ...
    i.Circle.prototype = {
        ...
        sample: function(t, e, s, n, r) {
            ...
            r || (r = []);
            for (var o = 0; o < t; )
                this.circumferencePoint(i.Math.linear(e, s, o / t), n, r[o] || (r[o] = new i.Point)),
                o += 1;
            return r
        },
        offset: function(t, e) {
    ...
    i.Line.intersectsRectangle = function(t, e) {
        ...
        var i = t.start.x
          ...
          , u = e.bottom
          , l = 0;
        if (i >= o && i <= h && s >= a && s <= u || n >= o && n <= h && r >= a && r <= u)
            return !0;
        if (i < o && n >= o) {
            if ((l = s + (r - s) * (o - i) / (n - i)) > a && l <= u)
                return !0
        } else if (i > h && n <= h && (l = s + (r - s) * (h - i) / (n - i)) >= a && l <= u)
            return !0;
        if (s < a && r >= a) {
            if ((l = i + (n - i) * (a - s) / (r - s)) >= o && l <= h)
                return !0
        } else if (s > u && r <= u && (l = i + (n - i) * (u - s) / (r - s)) >= o && l <= h)
            return !0;
        return !1
    }
    ,
    i.Line.intersectionWithRectangle = function(t, e, s) {
        ...
        s || (s = new i.Point),
        n.edges || (n.edges = [new i.Line, new i.Line, new i.Line, new i.Line]),
        n.edgeIntersection || (n.edgeIntersection = new i.Point);
        var r = n.edges
    ...
    i.Point.prototype = {
        ...
        setToPolar: function(t, e, s) {
            return null == e && (e = 1),
            s && (t = i.Math.degToRad(t)),
            this.setTo(Math.cos(t) * e, Math.sin(t) * e)
        },
        add: function(t, e) {
            return this.x += t,
            this.y += e,
    ...
    i.Point.sortClockwise = function(t, e) {
        ...
        return t.sort(function(t, e) {
            ...
            if (t.x - i < 0 && e.x - i >= 0)
                return 1;
            if (t.x - i == 0 && e.x - i == 0)
                return t.y - s >= 0 || e.y - s >= 0 ? t.y > e.y ? 1 : -1 : e.y > t.y ? 1 : -1;
    ...
    i.Rectangle.prototype = {
        ...
        sides: function(t, e, s, n) {
            ...
            var r = this.x
              ...
              , a = this.right
              , h = this.bottom;
            return t.setTo(r, o, a, o),
            e.setTo(a, o, a, h),
            s.setTo(r, h, a, h),
            n.setTo(r, o, r, h),
            arguments.length ? null : [t, e, s, n]
        },
        toString: function() {
    ...
    i.Rectangle.createFromBounds = function(t, e) {
        return void 0 !== e && null !== e || (e = new i.Rectangle(t.x,t.y,t.width,t.height)),
        e.copyFromBounds(t)
    }
    ,
    ...
    i.Camera = function(t, e, s, n, r, o) {
        ...
        this.scale = null,
        this.totalInView = 0,
        this.lerp = new i.Point(1,1),
        this.onShakeComplete = new i.Signal,
        this.onFlashComplete = new i.Signal,
        ...
        this._fxDuration = 0,
        this._fxType = 0,
        this._fixedView = new i.Rectangle
    }
    ,
    ...
    i.Camera.SHAKE_BOTH = 4,
    i.Camera.SHAKE_HORIZONTAL = 5,
    i.Camera.SHAKE_VERTICAL = 6,
    i.Camera.ENABLE_FX = !0,
    i.Camera.prototype = {
        boot: function() {
            this.displayObject = this.game.world,
            this.scale = this.game.world.scale,
            this.game.camera = this,
            i.Graphics && i.Camera.ENABLE_FX && (this.fx = new i.Graphics(this.game),
        ...
        follow: function(t, e, s, n) {
            ...
            case i.Camera.FOLLOW_TOPDOWN:
                ...
                this.deadzone = new i.Rectangle((this.width - r) / 2,(this.height - r) / 2,r,r);
                break;
        ...
        shake: function(t, e, s, n, r) {
            ...
            void 0 === e && (e = 500),
            void 0 === s && (s = !0),
            void 0 === n && (n = i.Camera.SHAKE_BOTH),
            void 0 === r && (r = !0),
            !(!s && this._shake.duration > 0) && (this._shake.intensity = t,
            this._shake.duration = e,
            this._shake.shakeBounds = r,
            this._shake.x = 0,
            this._shake.y = 0,
            this._shake.horizontal = n === i.Camera.SHAKE_BOTH || n === i.Camera.SHAKE_HORIZONTAL,
            this._shake.vertical = n === i.Camera.SHAKE_BOTH || n === i.Camera.SHAKE_VERTICAL,
            !0)
        },
    ...
    i.StateManager.prototype = {
        ...
        add: function(t, e, s) {
            void 0 === s && (s = !1);
            var n;
            return e instanceof i.State ? n = e : "object" == typeof e ? (n = e).game = this.game : "function" == typeof e && (n = new e(this.game)),
            this.states[t] = n,
        ...
        checkState: function(t) {
            var e = this.states[t];
            return e ? !!(e.preload || e.create || e.update || e.render) || (console.warn("Invalid Phaser State object given. Must contain at least one of the required functions: preload, create, update or render"),
    ...
    i.Signal.prototype = {
        ...
        _registerListener: function(t, e, s, n, r) {
            ...
            if (-1 !== a) {
                if ((o = this._bindings[a]).isOnce() !== e)
    ...
    i.Filter.prototype = {
        ...
        addToWorld: function(t, e, s, n, r, o) {
            void 0 === r && (r = 0),
            void 0 === o && (o = 0),
            void 0 !== s && null !== s ? this.width = s : s = this.width,
    ...
    i.Stage.prototype.add = function(t, e, i) {
        return t.parent === this ? t : (t.body && t.parent && t.parent.hash && t.parent.removeFromHash(t),
        void 0 === i ? this.addChild(t) : this.addChildAt(t, i),
        t)
    }
    ,
    ...
    i.Group = function(t, e, s, n, r, o) {
        ...
        this.onChildInputDown = new i.Signal,
        this.onChildInputUp = new i.Signal,
        this.onChildInputOver = new i.Signal,
        this.onChildInputOut = new i.Signal,
        this.enableBody = r,
    ...
    i.Group.RETURN_ALL = 3,
    i.Group.SORT_ASCENDING = -1,
    i.Group.SORT_DESCENDING = 1,
    i.Group.prototype.add = function(t, e, i) {
        return void 0 === e && (e = !1),
        t.parent === this ? t : (t.body && t.parent && t.parent.hash && t.parent.removeFromHash(t),
    ...
    i.Group.prototype.align = function(t, e, s, n, r, o) {
        if (void 0 === r && (r = i.TOP_LEFT),
        void 0 === o && (o = 0),
        0 === this.children.length || o > this.children.length || -1 === t && -1 === e)
            return !1;
    ...
    i.Group.prototype.replace = function(t, e) {
        ...
        if (-1 !== s)
            return e.parent && (e.parent instanceof i.Group ? e.parent.remove(e) : e.parent.removeChild(e)),
            this.remove(t),
            this.addAt(e, s),
            t
    }
    ...
    i.Group.prototype.checkAll = function(t, e, i, s, n) {
        ...
        for (var r = 0; r < this.children.length; r++) {
            ...
            if ((!i || i && o.alive) && (!s || s && o.visible) && !this.checkProperty(o, t, e, n))
                return !1
        }
        return !0
    }
    ...
    i.Group.prototype.checkAny = function(t, e, i, s) {
        ...
        for (var n = 0; n < this.children.length; n++) {
            ...
            if ((!i || i && r.alive) && (!s || s && r.visible) && this.checkProperty(r, t, e))
                return !0
        }
        return !1
    }
    ...
    i.Group.prototype.callAll = function(t, e) {
        if (void 0 !== t) {
            ...
            for (var r = null, o = null, a = 0; a < this.children.length; a++)
                r = this.callbackFromArray(this.children[a], t, i),
                e && r ? (o = this.callbackFromArray(this.children[a], e, s),
                r && r.apply(o, n)) : r && r.apply(this.children[a], n)
        }
    }
    ,
    ...
    i.Group.prototype.forEach = function(t, e, i) {
        ...
        arguments.length <= 3)
            for (n = 0; n < this.children.length; n++)
                (!i || i && this.children[n].exists) && t.call(e, this.children[n]);
        else {
            for (var s = [null], n = 3; n < arguments.length; n++)
                s.push(arguments[n]);
            for (n = 0; n < this.children.length; n++)
                (!i || i && this.children[n].exists) && (s[0] = this.children[n],
                t.apply(e, s))
        }
    }
    ,
    ...
    i.Group.prototype.iterate = function(t, e, s, n, r, o) {
        if (0 === this.children.length) {
            if (s === i.Group.RETURN_TOTAL)
                return 0;
            if (s === i.Group.RETURN_ALL)
                return []
        }
        var a = 0;
        if (s === i.Group.RETURN_ALL)
        ...
        for (var u = 0; u < this.children.length; u++)
            if (this.children[u][t] === e) {
                if (a++,
                n && (o ? (o[0] = this.children[u],
                n.apply(r, o)) : n.call(r, this.children[u])),
    ...
    i.Group.prototype.getClosestTo = function(t, e, s) {
        for (var n = Number.MAX_VALUE, r = 0, o = null, a = 0; a < this.children.length; a++) {
            ...
            h.exists && (r = Math.abs(i.Point.distance(t, h))) < n && (!e || e.call(s, h, r)) && (n = r,
            o = h)
        }
        return o
    }
    ...
    i.Group.prototype.getRandom = function(t, e) {
        return void 0 === t && (t = 0),
        void 0 === e && (e = this.children.length),
        0 === e ? null : i.ArrayUtils.getRandomItem(this.children, t, e)
    }
    ,
    ...
    i.Group.prototype.shuffle = function() {
        i.ArrayUtils.shuffle(this.children),
        this.updateZ()
    }
    ,
    ...
    i.Game = function(t, e, s, n, r, o, a, h) {
        ...
        void 0 !== s && (this.renderType = s),
        void 0 !== n && (this.parent = n),
        void 0 !== o && (this.transparent = o),
    ...
    i.Game.prototype = {
        ...
        showDebugHeader: function() {
            if (!window.PhaserGlobal || !window.PhaserGlobal.hideBanner) {
                ...
                n++),
                this.device.ie)
                    window.console && console.log("Phaser v" + t + " | Pixi.js | " + e + " | " + s + " | http://phaser.io");
                else {
                    for (var r = ["%c %c %c Phaser CE v" + t + " | Pixi.js | " + e + " | " + s + "  %c %c %c http://phaser.io %c♥%c♥%c♥", "background: #fb8cb3", "background: #d44a52", "color: #ffffff; background: #871905;", "background: #d44a52", "background: #fb8cb3", "background: #ffffff"], o = 0; o < 3; o++)
                        o < n ? r.push("color: #ff2424; background: #fff") : r.push("color: #959595; background: #fff");
        ...
        setUpRenderer: function() {
            ...
            this.config.crisp && i.Canvas.setImageRenderingCrisp(this.canvas),
            this.renderType === i.WEBGL || this.renderType === i.WEBGL_MULTI || this.renderType === i.AUTO && this.device.webGL) {
                (this.multiTexture || this.renderType === i.WEBGL_MULTI) && (PIXI.enableMultiTexture(),
                this.multiTexture = !0);
                try {
                    ...
                    this.multiTexture = !1,
                    PIXI._enableMultiTextureToggle = !1,
                    this.renderType === i.WEBGL)
                        throw t
                }
            }
            this.renderer || (this.renderer = new PIXI.CanvasRenderer(this,this.config),
            this.context = this.renderer.context,
            this.renderType === i.AUTO && (this.renderType = i.CANVAS)),
        ...
        update: function(t) {
            if (this.pendingDestroy)
                ...
                if (this._spiraling > 1 && !this.forceSingleUpdate)
                    ...
                    this._deltaTime = 0,
                    this._spiraling = 0,
                    this.dropFrames ? this.rendersThisFrame = 0 : (this.updateRender(this.time.slowMotion * this.time.desiredFps),
                    this.rendersThisFrame = 1);
                else {
                    ...
                    this.forceSingleUpdate && (this.updatesThisFrame = Math.min(1, this.updatesThisFrame)),
        ...
        updateLogic: function(t) {
            ...
            this.input.pauseUpdate()) : (this.stepping && (this.pendingStep = !0),
        ...
        updateRender: function(t) {
            this.lockRender || (this.time.countRender(),
            this.state.preRender(t),
            this.renderType !== i.HEADLESS && (this.renderer.render(this.stage),
    ...
    i.Input.prototype = {
        boot: function() {
            ...
            this.hitCanvas = i.CanvasPool.create(this, 1, 1),
        ...
        hitTest: function(t, e, s) {
            ...
            if (i.Creature && t instanceof i.Creature) {
                ...
                if (this.game.camera.x + e.x >= o && this.game.camera.x + e.x < o + n) {
                    a = t.y - r * t.anchorY;
                    if (this.game.camera.y + e.y >= a && this.game.camera.y + e.y < a + r)
                        return !0
                }
            ...
            for (var u = 0; u < t.children.length; u++)
                if (this.hitTest(t.children[u], e, s))
                    return !0;
            return !1
        },
    ...
    t.prototype.bindEvent = function(e) {
        if (!t._stubsGenerated && e) {
            for (var i in e)
                i in t.prototype || Object.defineProperty(t.prototype, i, {
                    get: function(t) {
                        return function() {
    ...
    i.Pointer.prototype = {
        ...
        processButtonsDown: function(t, e) {
            t === i.Mouse.LEFT_BUTTON && this.leftButton.start(e),
            t === i.Mouse.RIGHT_BUTTON && this.rightButton.start(e),
            t === i.Mouse.MIDDLE_BUTTON && this.middleButton.start(e),
            t === i.Mouse.BACK_BUTTON && this.backButton.start(e),
            t === i.Mouse.FORWARD_BUTTON && this.forwardButton.start(e)
        },
        ...
        processButtonsUpDown: function(t, e) {
            ...
            void 0 !== t ? (s && 1 === t && e.ctrlKey && (t = 2),
            this.leftButton.startStop(i.Pointer.LEFT_BUTTON & t, e),
            this.rightButton.startStop(i.Pointer.RIGHT_BUTTON & t, e),
            this.middleButton.startStop(i.Pointer.MIDDLE_BUTTON & t, e),
            this.backButton.startStop(i.Pointer.BACK_BUTTON & t, e),
            this.forwardButton.startStop(i.Pointer.FORWARD_BUTTON & t, e),
            this.eraserButton.startStop(i.Pointer.ERASER_BUTTON & t, e)) : void 0 !== e.button ? s && e.ctrlKey && 0 === e.button ? this.rightButton.start(e) : s ? this.processButtonsDown(e.button, e) : n || this.processButtonsUp(e.button, e) : s ? e.ctrlKey ? this.rightButton.start(e) : this.leftButton.start(e) : (this.leftButton.stop(e),
        ...
        update: function() {
            ...
            this.dirty = !1),
            !1 === this._holdSent && this.duration >= t.holdRate && ((t.multiInputOverride === i.Input.MOUSE_OVERRIDES_TOUCH || t.multiInputOverride === i.Input.MOUSE_TOUCH_COMBINE || t.multiInputOverride === i.Input.TOUCH_OVERRIDES_MOUSE && 0 === t.totalActivePointers) && t.onHold.dispatch(this),
            this._holdSent = !0),
        ...
        move: function(t, e) {
            ...
            if (!s.pollLocked) {
                ...
                this.isMouse && this.updateButtons(t),
                ...
                return null === this.targetObject || this.game.paused && !this.targetObject.noPause || !0 !== this.targetObject.isDragged ? s.interactiveItems.total > 0 && this.processInteractiveObjects(e) : !1 === this.targetObject.update(this) && (this.targetObject = null),
                this
            }
        },
        ...
        swapTarget: function(t, e) {
            ...
            this.targetObject = null) : null === this.targetObject ? (this.targetObject = t,
            t._pointerOverHandler(this, e)) : this.targetObject === t ? !1 === t.update(this) && (this.targetObject = null) : (this.targetObject._pointerOutHandler(this, e),
            this.targetObject = t,
    ...
    i.Touch.prototype = {
        ...
        onTouchStart: function(t) {
            if (this.game.input.executeTouchLockCallbacks(!1, t),
            this.event = t,
    ...
    i.InputHandler.prototype = {
        ...
        update: function(t) {
            if (null !== this.sprite && void 0 !== this.sprite.parent)
                return this.enabled && this.sprite.visible && this.sprite.parent.visible ? this._pendingDrag ? (this._dragDistancePass || (this._dragDistancePass = i.Math.distance(t.x, t.y, this.downPoint.x, this.downPoint.y) >= this.dragDistanceThreshold),
        ...
        updateDrag: function(t, e) {
            ...
            if (this.sprite.fixedToCamera)
                var s = this.game.camera.scale.x * i.x + this._dragPoint.x + this.dragOffset.x
                  , n = this.game.camera.scale.y * i.y + this._dragPoint.y + this.dragOffset.y;
            else
                var s = i.x + this._dragPoint.x + this.dragOffset.x
                  , n = i.y + this._dragPoint.y + this.dragOffset.y;
            if (this.sprite.fixedToCamera)
                this.allowHorizontalDrag && (this.sprite.cameraOffset.x = s - this.game.camera.x),
                this.allowVerticalDrag && (this.sprite.cameraOffset.y = n - this.game.camera.y),
        ...
        startDrag: function(t) {
            ...
            this.dragStartPoint.set(e, s),
            this.sprite.events.onDragStart$dispatch(this.sprite, t, e, s),
            this._pendingDrag = !1
        },
    ...
    i.Keyboard.prototype = {
        ...
        processKeyDown: function(t) {
            ...
            this.game.input.enabled && this.enabled) {
                ...
                this._keys[e] || (this._keys[e] = new i.Key(this.game,e)),
    ...
    i.Group.prototype.alignIn = i.Component.Bounds.prototype.alignIn,
    i.Group.prototype.alignTo = i.Component.Bounds.prototype.alignTo,
    ...
    ,
    i.Component.Core.skipTypeChecks = !1,
    ...
    i.Component.Core.init = function(t, e, s, n, r) {
        if (!i.Component.Core.skipTypeChecks) {
            if (!(t instanceof i.Game))
                throw new Error("The value passed as the `game` argument (" + t + ") is not an instance of Phaser.Game.");
            "number" != typeof e && (console.warn("The `x` argument value (%s) should be a number.", e),
            e = 0),
            "number" != typeof s && (console.warn("The `y` argument value (%s) should be a number.", s),
            s = 0)
        }
        this.game = t,
        this.key = n,
    ...
    i.Component.Core.preUpdate = function() {
        return this.pendingDestroy ? (this.destroy(),
        !1) : (this.previousPosition.set(this.world.x, this.world.y),
        this.previousRotation = this.rotation,
        this.exists && this.parent.exists ? (this.world.setTo(this.game.camera.x + this.worldTransform.tx, this.game.camera.y + this.worldTransform.ty),
    ...
    i.Component.Crop.prototype = {
        ...
        updateCrop: function() {
            if (this.cropRect) {
                ...
                16777215 === this.tint || t === r && e === o && s === a && n === h || (this.texture.requiresReTint = !0)
            }
        }
    },
    ...
    i.Component.LifeSpan.preUpdate = function() {
        return this.pendingDestroy ? (this.destroy(),
        !1) : !(this.lifespan > 0 && (this.lifespan -= this.game.time.physicsElapsedMS,
    ...
    i.Component.LoadTexture.prototype = {
        ...
        loadTexture: function(t, e, s) {
            ...
            if (i.RenderTexture && t instanceof i.RenderTexture)
                ...
                r = n.hasFrameData(t.key, i.Cache.BITMAPDATA) ? !this.animations.loadFrameData(n.getFrameData(t.key, i.Cache.BITMAPDATA), e) : !this.animations.loadFrameData(t.frameData, 0);
            ...
            } else if (i.Tilemap && t instanceof i.TilemapLayer)
    ...
    i.Component.PhysicsBody.preUpdate = function() {
        return this.pendingDestroy ? (this.destroy(),
        !1) : this.fresh && this.exists ? (this.world.setTo(this.parent.position.x + this.position.x, this.parent.position.y + this.position.y),
    ...
    i.Component.Smoothed.prototype = {
        smoothed: {
            ...
            set: function(t) {
                ...
                this.texture.baseTexture.dirty()) : this.texture && (this.texture.baseTexture.scaleMode = 1,
    ...
    i.GameObjectFactory.prototype = {
        ...
        sprite: function(t, e, s, n, r) {
            return void 0 === r && (r = this.world),
            r.add(new i.Sprite(this.game,t,e,s,n))
        },
        ...
        button: function(t, e, s, n, r, o, a, h, u, l) {
            ...
            l.add(new i.Button(this.game,t,e,s,n,r,o,a,h,u))
        },
        ...
        filter: function(t) {
            var e = Array.prototype.slice.call(arguments, 1);
            return (t = new i.Filter[t](this.game)).init.apply(t, e),
            t
        },
        plugin: function(t) {
    ...
    i.Sprite = function(t, e, s, n, r) {
        ...
        PIXI.Sprite.call(this, i.Cache.DEFAULT),
    ...
    i.Component.Core.install.call(i.Image.prototype, ["Angle", "Animation", "AutoCull", "Bounds", "BringToTop", "Crop", "Destroy", "FixedToCamera", "InputEnabled", "LifeSpan", "LoadTexture", "Overlap", "Reset", "ScaleMinMax", "Smoothed"]),
    i.Image.prototype.preUpdateLifeSpan = i.Component.LifeSpan.preUpdate,
    ...
    i.Button = function(t, e, s, n, r, o, a, h, u, l) {
        ...
        this.justReleasedPreventsOver = i.PointerMode.CONTACT,
        this.freezeFrames = !1,
        this.forceOut = !1,
        this.inputEnabled = !0,
        this.input.start(0, !0),
        this.input.useHandCursor = !0,
        this.setFrames(a, h, u, l),
    ...
    i.Button.prototype.onInputOverHandler = function(t, e) {
        e.justReleased() && (this.justReleasedPreventsOver & e.pointerMode) === e.pointerMode || (this.changeStateFrame("Over"),
        this.onOverMouseOnly && !e.isMouse || (this.playStateSound("Over"),
    ...
    ,
    i.SpriteBatch.prototype = Object.create(i.Group.prototype),
            ...
            for (var i = this.worldTransform, s = !0, n = 0; n < this.children.length; n++) {
                ...
                if (r.visible) {
                    ...
                    r.rotation % (2 * Math.PI) == 0)
                        ...
                        t.roundPixels ? e.setTransform(h.a, h.b, h.c, h.d, 0 | u, 0 | l) : e.setTransform(h.a, h.b, h.c, h.d, u, l),
    ...
    i.BitmapData = function(t, e, s, n, r) {
        ...
        this.width = s,
        this.height = n,
        this.canvas = i.Canvas.create(this, s, n, null, r),
        this.context = this.canvas.getContext("2d", {
            alpha: !0
        }),
        this.ctx = this.context,
        this.smoothProperty = t.renderType === i.CANVAS ? t.renderer.renderSession.smoothProperty : i.Canvas.getSmoothingPrefix(this.context),
        ...
        this.textureFrame = this.frameData.addFrame(new i.Frame(0,0,0,s,n,"bitmapData")),
    ...
    i.BitmapData.prototype = {
        ...
        moveH: function(t, e) {
            void 0 === e && (e = !0),
            void 0 === this._swapCanvas && (this._swapCanvas = i.CanvasPool.create(this, this.width, this.height));
        ...
        generateTexture: function(t, e, i) {
            ...
            n.src = this.canvas.toDataURL("image/png"),
            !e) {
                var r = s.addImage(t, "", n);
        ...
        processPixelRGB: function(t, e, s, n, r, o) {
            ...
            for (var a = s + r, h = n + o, u = i.Color.createColor(), l = {
                ...
                for (var p = s; p < a; p++)
                    i.Color.unpackPixel(this.getPixel32(p, d), u),
                    !1 !== (l = t.call(e, u, p, d)) && null !== l && void 0 !== l && (this.setPixel32(p, d, l.r, l.g, l.b, l.a, !1),
                    c = !0);
        ...
        processPixel: function(t, e, i, s, n, r) {
            ...
            for (var o = i + n, a = s + r, h = 0, u = 0, l = !1, c = s; c < a; c++)
                for (var d = i; d < o; d++)
                    ...
                    (u = t.call(e, h, d, c)) !== h && (this.pixels[c * this.width + d] = u,
                    l = !0);
        ...
        replaceRGB: function(t, e, s, n, r, o, a, h, u) {
            ...
            void 0 !== u && u instanceof i.Rectangle && (l = u.x,
            c = u.y,
            d = u.width,
            p = u.height);
            for (var g = 0; g < p; g++)
                for (var m = 0; m < d; m++)
                    this.getPixel32(l + m, c + g) === f && this.setPixel32(l + m, c + g, r, o, a, h, !1);
        ...
        setHSL: function(t, e, s, n) {
            ...
            if (r || o || a) {
                ...
                for (var h = i.Color.createColor(), u = n.y; u < n.bottom; u++)
                    for (var l = n.x; l < n.right; l++)
                        i.Color.unpackPixel(this.getPixel32(l, u), h, !0),
                        r && (h.h = t),
                        o && (h.s = e),
                        a && (h.l = s),
                        i.Color.HSLtoRGB(h.h, h.s, h.l, h),
                        this.setPixel32(l, u, h.r, h.g, h.b, h.a, !1);
                return this.context.putImageData(this.imageData, 0, 0),
                this.dirty = !0,
                this
            }
        ...
        getFirstPixel: function(t) {
            ...
            do {
                ...
                0 === t || 1 === t ? ++s === this.width && (s = 0,
                ((n += r) >= this.height || n <= 0) && (o = !0)) : 2 !== t && 3 !== t || ++n === this.height && (n = 0,
                ((s += r) >= this.width || s <= 0) && (o = !0))
            } while (0 === e.a && !o);
            return e.x = s,
            e.y = n,
            e
        ...
        copy: function(t, e, s, n, r, o, a, h, u, l, c, d, p, f, g, m, y) {
            ...
            t instanceof i.RenderTexture && (t = t.getCanvas()),
            this._image = t,
            ...
            void 0 !== u && null !== u || (u = this._size.y),
            ...
            !(this._alpha.current <= 0 || 0 === this._scale.x || 0 === this._scale.y || 0 === this._size.x || 0 === this._size.y)) {
                ...
                v.drawImage(this._image, this._pos.x + e, this._pos.y + s, this._size.x, this._size.y, -h * this._anchor.x, -u * this._anchor.y, h, u),
                v.restore(),
        ...
        copyTransform: function(t, e, s) {
            ...
            e && (this.op = e),
            a[this.smoothProperty] = t.texture.baseTexture.scaleMode === PIXI.scaleModes.LINEAR,
            a.setTransform(n.a, n.b, n.c, n.d, r, o),
            a.drawImage(this._image, this._pos.x, this._pos.y, this._size.x, this._size.y, -this._size.x * t.anchor.x, -this._size.y * t.anchor.y, this._size.x, this._size.y),
            a.restore(),
        ...
        drawGroupProxy: function(t, e, s) {
            if (t.hasOwnProperty("texture") && this.copyTransform(t, e, s),
            t.type === i.GROUP && t.exists)
                this.drawGroup(t, e, s);
            else if (t.hasOwnProperty("children") && t.children.length > 0)
                for (var n = 0; n < t.children.length; n++)
                    t.children[n].exists && this.copyTransform(t.children[n], e, s)
        },
        ...
        shadow: function(t, e, i, s) {
            var n = this.context;
            return void 0 === t || null === t ? n.shadowColor = "rgba(0,0,0,0)" : (n.shadowColor = t,
            n.shadowBlur = e || 5,
        ...
        extract: function(t, e, i, s, n, r, o, a, h) {
            ...
            this.processPixelRGB(function(r, u, l) {
                return r.r === e && r.g === i && r.b === s && t.setPixel32(u, l, o, a, h, n, !1),
                !1
            }, this),
    ...
    i.EarCut = {},
    i.EarCut.Triangulate = function(t, e, s) {
        s = s || 2;
        var n = e && e.length
          , r = n ? e[0] * s : t.length
        ...
        if (!o)
            return a;
        var h, u, l, c, d, p, f;
        if (n && (o = i.EarCut.eliminateHoles(t, e, o, s)),
        t.length > 80 * s) {
            h = l = t[0],
            u = c = t[1];
            for (var g = s; g < r; g += s)
        ...
        return i.EarCut.earcutLinked(o, a, s, h, u, f),
        a
    }
    ,
    i.EarCut.linkedList = function(t, e, s, n, r) {
        ...
        for (o = e,
        a = s - n; o < s; o += n)
            u += (t[a] - t[o]) * (t[o + 1] + t[a + 1]),
            a = o;
        if (r === u > 0)
            for (o = e; o < s; o += n)
                h = i.EarCut.insertNode(o, t[o], t[o + 1], h);
        else
            for (o = s - n; o >= e; o -= n)
                h = i.EarCut.insertNode(o, t[o], t[o + 1], h);
        return h
    ...
    i.EarCut.filterPoints = function(t, e) {
        ...
        do {
            if (s = !1,
            n.steiner || !i.EarCut.equals(n, n.next) && 0 !== i.EarCut.area(n.prev, n, n.next))
                n = n.next;
            else {
                if (i.EarCut.removeNode(n),
                (n = e = n.prev) === n.next)
                    return null;
                s = !0
            }
    ...
    i.EarCut.earcutLinked = function(t, e, s, n, r, o, a) {
        if (t) {
            ...
            for (var h, u, l = t; t.prev !== t.next; )
                if (h = t.prev,
                u = t.next,
                o ? i.EarCut.isEarHashed(t, n, r, o) : i.EarCut.isEar(t))
                    e.push(h.i / s),
                    e.push(t.i / s),
                    e.push(u.i / s),
                    i.EarCut.removeNode(t),
                    t = u.next,
                    l = u.next;
                else if ((t = u) === l) {
                    a ? 1 === a ? (t = i.EarCut.cureLocalIntersections(t, e, s),
                    i.EarCut.earcutLinked(t, e, s, n, r, o, 2)) : 2 === a && i.EarCut.splitEarcut(t, e, s, n, r, o) : i.EarCut.earcutLinked(i.EarCut.filterPoints(t), e, s, n, r, o, 1);
                    break
                }
        }
    }
    ...
    i.EarCut.isEar = function(t) {
        var e = t.prev
          , s = t
          , n = t.next;
        if (i.EarCut.area(e, s, n) >= 0)
            return !1;
        for (var r = t.next.next; r !== t.prev; ) {
            if (i.EarCut.pointInTriangle(e.x, e.y, s.x, s.y, n.x, n.y, r.x, r.y) && i.EarCut.area(r.prev, r, r.next) >= 0)
                return !1;
            r = r.next
        }
        return !0
    ...
    i.EarCut.isEarHashed = function(t, e, s, n) {
        ...
        for (var h = r.x < o.x ? r.x < a.x ? r.x : a.x : o.x < a.x ? o.x : a.x, u = r.y < o.y ? r.y < a.y ? r.y : a.y : o.y < a.y ? o.y : a.y, l = r.x > o.x ? r.x > a.x ? r.x : a.x : o.x > a.x ? o.x : a.x, c = r.y > o.y ? r.y > a.y ? r.y : a.y : o.y > a.y ? o.y : a.y, d = i.EarCut.zOrder(h, u, e, s, n), p = i.EarCut.zOrder(l, c, e, s, n), f = t.nextZ; f && f.z <= p; ) {
            if (f !== t.prev && f !== t.next && i.EarCut.pointInTriangle(r.x, r.y, o.x, o.y, a.x, a.y, f.x, f.y) && i.EarCut.area(f.prev, f, f.next) >= 0)
                return !1;
            f = f.nextZ
        }
    ...
    i.EarCut.cureLocalIntersections = function(t, e, s) {
        ...
        do {
            var r = n.prev
              , o = n.next.next;
            i.EarCut.intersects(r, n, n.next, o) && i.EarCut.locallyInside(r, o) && i.EarCut.locallyInside(o, r) && (e.push(r.i / s),
            e.push(n.i / s),
            e.push(o.i / s),
            i.EarCut.removeNode(n),
            i.EarCut.removeNode(n.next),
            n = t = o),
            n = n.next
        } while (n !== t);
        return n
        ...
        do {
            for (var h = a.next.next; h !== a.prev; ) {
                if (a.i !== h.i && i.EarCut.isValidDiagonal(a, h)) {
                    ...
                    return a = i.EarCut.filterPoints(a, a.next),
                    u = i.EarCut.filterPoints(u, u.next),
                    i.EarCut.earcutLinked(a, e, s, n, r, o),
                    void i.EarCut.earcutLinked(u, e, s, n, r, o)
                }
                h = h.next
            }
            a = a.next
    ...
    i.EarCut.eliminateHoles = function(t, e, s, n) {
        ...
        o = e.length; r < o; r++)
            a = e[r] * n,
            h = r < o - 1 ? e[r + 1] * n : t.length,
            (u = i.EarCut.linkedList(t, a, h, n, !1)) === u.next && (u.steiner = !0),
            l.push(i.EarCut.getLeftmost(u));
        for (l.sort(compareX),
        r = 0; r < l.length; r++)
            i.EarCut.eliminateHole(l[r], s),
            s = i.EarCut.filterPoints(s, s.next);
        return s
    }
    ,
    ...
    i.EarCut.findHoleBridge = function(t, e) {
        ...
        var u, l = s, c = 1 / 0;
        for (n = s.next; n !== l; )
            r >= n.x && n.x >= s.x && i.EarCut.pointInTriangle(o < s.y ? r : a, o, s.x, s.y, o < s.y ? a : r, o, n.x, n.y) && ((u = Math.abs(o - n.y) / (r - n.x)) < c || u === c && n.x > s.x) && i.EarCut.locallyInside(n, t) && (s = n,
            c = u),
            n = n.next;
        return s
    }
    ...
    i.EarCut.indexCurve = function(t, e, s, n) {
        var r = t;
        do {
            null === r.z && (r.z = i.EarCut.zOrder(r.x, r.y, e, s, n)),
            r.prevZ = r.prev,
            r.nextZ = r.next,
            r = r.next
        } while (r !== t);
    ...
    i.EarCut.intersectsPolygon = function(t, e) {
        var s = t;
        do {
            if (s.i !== t.i && s.next.i !== t.i && s.i !== e.i && s.next.i !== e.i && i.EarCut.intersects(s, s.next, t, e))
                return !0;
            s = s.next
        } while (s !== t);
        return !1
    ...
    PIXI.WebGLGraphics.renderGraphics = function(t, e) {
        var s, n = e.gl, r = e.projection, o = e.offset, a = e.shaderManager.primitiveShader;
        t.dirty && PIXI.WebGLGraphics.updateGraphics(t, n);
        var h = t._webGL[n.id];
        if (h)
            for (var u = 0; u < h.data.length; u++)
                1 === h.data[u].mode ? (s = h.data[u],
                e.stencilManager.pushStencil(t, s, e),
                n.drawElements(n.TRIANGLE_FAN, 4, n.UNSIGNED_SHORT, 2 * (s.indices.length - 4)),
                e.stencilManager.popStencil(t, s, e)) : (s = h.data[u],
                e.shaderManager.setShader(a),
                a = e.shaderManager.primitiveShader,
                n.uniformMatrix3fv(a.translationMatrix, !1, t.worldTransform.toArray(!0)),
                n.uniform1f(a.flipY, 1),
                n.uniform2f(a.projectionVector, r.x, -r.y),
                n.uniform2f(a.offsetVector, -o.x, -o.y),
                n.uniform3fv(a.tintColor, i.Color.hexToRGBArray(t.tint)),
                ...
                n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, s.indexBuffer),
                n.drawElements(n.TRIANGLE_STRIP, s.indices.length, n.UNSIGNED_SHORT, 0))
    }
    ,
    PIXI.WebGLGraphics.updateGraphics = function(t, e) {
        ...
        for (n = s.lastIndex; n < t.graphicsData.length; n++) {
            ...
            a.type === i.POLYGON ? (a.points = a.shape.points.slice(),
            ...
            a.fill && a.points.length >= PIXI.WebGLGraphics.stencilBufferLimit && (a.points.length < 2 * PIXI.WebGLGraphics.stencilBufferLimit ? (o = PIXI.WebGLGraphics.switchMode(s, 0),
            PIXI.WebGLGraphics.buildPoly(a, o) || (o = PIXI.WebGLGraphics.switchMode(s, 1),
            PIXI.WebGLGraphics.buildComplexPoly(a, o))) : (o = PIXI.WebGLGraphics.switchMode(s, 1),
            PIXI.WebGLGraphics.buildComplexPoly(a, o))),
            a.lineWidth > 0 && (o = PIXI.WebGLGraphics.switchMode(s, 0),
            PIXI.WebGLGraphics.buildLine(a, o))) : (o = PIXI.WebGLGraphics.switchMode(s, 0),
            a.type === i.RECTANGLE ? PIXI.WebGLGraphics.buildRectangle(a, o) : a.type === i.CIRCLE || a.type === i.ELLIPSE ? PIXI.WebGLGraphics.buildCircle(a, o) : a.type === i.ROUNDEDRECTANGLE && PIXI.WebGLGraphics.buildRoundedRectangle(a, o)),
            s.lastIndex++
        }
        for (n = 0; n < s.data.length; n++)
            (o = s.data[n]).dirty && o.upload()
    }
    ,
    ...
    PIXI.WebGLGraphics.buildRectangle = function(t, e) {
        ...
        if (t.lineWidth) {
            var m = t.points;
            t.points = [n, r, n + o, r, n + o, r + a, n, r + a, n, r],
    ...
    PIXI.WebGLGraphics.buildRoundedRectangle = function(t, e) {
        var s = t.shape
          ...
          , u = [];
        if (u.push(n, r + h),
        u = u.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n, r + a - h, n, r + a, n + h, r + a)),
        u = u.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + o - h, r + a, n + o, r + a, n + o, r + a - h)),
        u = u.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + o, r + h, n + o, r, n + o - h, r)),
        u = u.concat(PIXI.WebGLGraphics.quadraticBezierCurve(n + h, r, n, r, n, r + h)),
        t.fill) {
    ...
    PIXI.WebGLGraphics.quadraticBezierCurve = function(t, e, i, s, n, r) {
        ...
        for (var a, h, u, l, c, d, p = [], f = 0, g = 0; g <= 20; g++)
            a = o(t, i, f = g / 20),
            h = o(e, s, f),
            u = o(i, n, f),
            l = o(s, r, f),
    ...
    PIXI.WebGLGraphics.buildCircle = function(t, e) {
        var s, n, r = t.shape, o = r.x, a = r.y;
        t.type === i.CIRCLE ? (s = r.radius,
        n = r.radius) : (s = r.width,
        n = r.height);
        var h = 2 * Math.PI / 40
          , u = 0;
        if (t.fill) {
            ...
            u = 0; u < 41; u++)
                g.push(o, a, d, p, f, c),
                g.push(o + Math.sin(h * u) * s, a + Math.cos(h * u) * n, d, p, f, c),
                m.push(y++, y++);
            m.push(y - 1)
        }
        if (t.lineWidth) {
            ...
            for (t.points = [],
            u = 0; u < 41; u++)
                t.points.push(o + Math.sin(h * u) * s, a + Math.cos(h * u) * n);
            PIXI.WebGLGraphics.buildLine(t, e),
            t.points = v
        }
    }
    ...
    PIXI.WebGLGraphics.buildLine = function(t, e) {
        ...
        if (0 !== n.length) {
            ...
            var u, l, c, d, p, f, g, m, y, v, x, _, b, T, w, C, S, P, E, A, M, R, O = e.points, I = e.indices, L = n.length / 2, D = n.length, k = O.length / 6, F = t.lineWidth / 2, B = i.Color.hexToRGBArray(t.lineColor), U = t.lineAlpha, G = B[0] * U, N = B[1] * U, X = B[2] * U;
            for (c = n[0],
            d = n[1],
            p = n[2],
            y = -(d - (f = n[3])),
            ...
            s = 1; s < L - 1; s++)
                ...
                x = -(f - m),
                _ = p - g,
                x /= R = Math.sqrt(x * x + _ * _),
                _ /= R,
                S = (-y + c) * (-v + f) - (-y + p) * (-v + d),
                A = (-(x *= F) + g) * (-(_ *= F) + f) - (-x + p) * (-_ + m),
                M = (w = -v + d - (-v + f)) * (E = -x + p - (-x + g)) - (P = -_ + m - (-_ + f)) * (C = -y + p - (-y + c)),
                Math.abs(M) < .1 ? (M += 10.1,
                O.push(p - y, f - v, G, N, X, U),
                O.push(p + y, f + v, G, N, X, U)) : ((u = (C * A - E * S) / M) - p) * (u - p) + ((l = (P * S - w * A) / M) - f) + (l - f) > 19600 ? (b = y - x,
                T = v - _,
                b /= R = Math.sqrt(b * b + T * T),
                T /= R,
                b *= F,
                T *= F,
                O.push(p - b, f - T),
    ...
    PIXI.WebGLGraphics.buildComplexPoly = function(t, e) {
        ...
        if (!(s.length < 6)) {
            ...
            e.points = s,
            e.alpha = t.fillAlpha,
            e.color = i.Color.hexToRGBArray(t.fillColor);
            for (var r, o, a = 1 / 0, h = -1 / 0, u = 1 / 0, l = -1 / 0, c = 0; c < s.length; c += 2)
                r = s[c],
                o = s[c + 1],
                a = r < a ? r : a,
                h = r > h ? r : h,
    ...
    PIXI.CanvasGraphics.renderGraphics = function(t, e) {
        ...
        for (var n = 0; n < t.graphicsData.length; n++) {
            ...
            r.type === i.POLYGON) {
                ...
                r.fill && (e.globalAlpha = r.fillAlpha * s,
                e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6),
                e.fill()),
                r.lineWidth && (e.globalAlpha = r.lineAlpha * s,
                e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6),
                e.stroke())
            } else if (r.type === i.RECTANGLE)
                (r.fillColor || 0 === r.fillColor) && (e.globalAlpha = r.fillAlpha * s,
                e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6),
                e.fillRect(o.x, o.y, o.width, o.height)),
                r.lineWidth && (e.globalAlpha = r.lineAlpha * s,
                e.strokeStyle = "#" + ("00000" + (0 | h).toString(16)).substr(-6),
                e.strokeRect(o.x, o.y, o.width, o.height));
            else if (r.type === i.CIRCLE)
                e.beginPath(),
                ...
                var g = c / 2 * .5522848
                  ...
                  , _ = f + d / 2;
                e.moveTo(p, _),
                e.bezierCurveTo(p, _ - m, x - g, f, x, f),
                e.bezierCurveTo(x + g, f, y, _ - m, y, _),
                e.bezierCurveTo(y, _ + m, x + g, v, x, v),
                e.bezierCurveTo(x - g, v, p, _ + m, p, _),
                e.closePath(),
                r.fill && (e.globalAlpha = r.fillAlpha * s,
                e.fillStyle = "#" + ("00000" + (0 | a).toString(16)).substr(-6),
                e.fill()),
                ...
                e.moveTo(b, T + S),
                e.lineTo(b, T + C - S),
                e.quadraticCurveTo(b, T + C, b + S, T + C),
                e.lineTo(b + w - S, T + C),
                e.quadraticCurveTo(b + w, T + C, b + w, T + C - S),
                e.lineTo(b + w, T + S),
            ...
            for (var n = 0; n < s; n++) {
                ...
                if (r.type === i.POLYGON) {
                    ...
                    var u = 2 * o.width
                      ...
                      , v = d + l / 2;
                    e.moveTo(c, v),
                    e.bezierCurveTo(c, v - f, y - p, d, y, d),
                    e.bezierCurveTo(y + p, d, g, v - f, g, v),
    ...
    ,
    i.GraphicsData.prototype.constructor = i.GraphicsData,
    i.GraphicsData.prototype.clone = function() {
    ...
    i.Graphics = function(t, e, s) {
        ...
        this._localBounds = new i.Rectangle(0,0,1,1),
        this.dirty = !0,
        this._boundsDirty = !1,
        this.webGLDirty = !1,
    ...
    ,
    i.Graphics.prototype = Object.create(PIXI.DisplayObjectContainer.prototype),
    ...
    i.Graphics.prototype.lineStyle = function(t, e, s) {
        ...
        this.currentPath && (this.currentPath.shape.points.length ? this.drawShape(new i.Polygon(this.currentPath.shape.points.slice(-2))) : (this.currentPath.lineWidth = this.lineWidth,
    ...
    i.Graphics.prototype.moveTo = function(t, e) {
        return this.drawShape(new i.Polygon([t, e])),
        this
    }
    ,
    ...
    i.Graphics.prototype.quadraticCurveTo = function(t, e, i, s) {
        ...
        for (var a = o[o.length - 2], h = o[o.length - 1], u = 0, l = 1; l <= 20; ++l)
            n = a + (t - a) * (u = l / 20),
            r = h + (e - h) * u,
            o.push(n + (t + (i - t) * u - n) * u, r + (e + (s - e) * u - r) * u);
        return this.dirty = !0,
        this._boundsDirty = !0,
        this
    }
    ...
    i.Graphics.prototype.bezierCurveTo = function(t, e, i, s, n, r) {
        this.currentPath ? 0 === this.currentPath.shape.points.length && (this.currentPath.shape.points = [0, 0]) : this.moveTo(0, 0);
        for (var o, a, h, u, l, c = this.currentPath.shape.points, d = c[c.length - 2], p = c[c.length - 1], f = 0, g = 1; g <= 20; ++g)
            h = (a = (o = 1 - (f = g / 20)) * o) * o,
            l = (u = f * f) * f,
            c.push(h * d + 3 * a * f * t + 3 * o * u * i + l * n, h * p + 3 * a * f * e + 3 * o * u * s + l * r);
        return this.dirty = !0,
        this._boundsDirty = !0,
        this
    }
    ...
    i.Graphics.prototype.drawRect = function(t, e, s, n) {
        return this.drawShape(new i.Rectangle(t,e,s,n)),
        this
    }
    ,
    i.Graphics.prototype.drawRoundedRect = function(t, e, s, n, r) {
        return this.drawShape(new i.RoundedRectangle(t,e,s,n,r)),
        this
    }
    ,
    i.Graphics.prototype.drawCircle = function(t, e, s) {
        return this.drawShape(new i.Circle(t,e,s)),
        this
    }
    ,
    i.Graphics.prototype.drawEllipse = function(t, e, s, n) {
        return this.drawShape(new i.Ellipse(t,e,s,n)),
        this
    }
    ,
    ...
    i.Graphics.prototype.containsPoint = function(t, e) {
        ...
        for (var s = this.graphicsData, n = 0; n < s.length; n++) {
            var r = s[n];
            if (r.fill && (r.shape && r.shape.contains(e.x, e.y)))
                return !0
        }
        return !1
    }
    ...
    i.Graphics.prototype.updateLocalBounds = function() {
        ...
        if (this.graphicsData.length)
            for (var r, o, a, h, u, l, c = 0; c < this.graphicsData.length; c++) {
                var d = this.graphicsData[c]
                  ...
                  , f = d.lineWidth;
                if (r = d.shape,
                p === i.RECTANGLE || p === i.ROUNDEDRECTANGLE)
                    a = r.x - f / 2,
                    h = r.y - f / 2,
                    u = r.width + f,
                    l = r.height + f,
                    ...
                    for (var g = 0; g < o.length; g++)
                        o[g]instanceof i.Point ? (a = o[g].x,
                        h = o[g].y) : (a = o[g],
                        h = o[g + 1],
                        g < o.length - 1 && g++),
                        t = a - f < t ? a - f : t,
        ...
        this._localBounds.width = e - t + 2 * m,
    ...
    i.Graphics.prototype.drawShape = function(t) {
        ...
        this.currentPath = null,
        t instanceof i.Polygon && (t = t.clone()).flatten();
        ...
        e.type === i.POLYGON && (e.shape.closed = this.filling,
        this.currentPath = e),
        this.dirty = !0,
        this._boundsDirty = !0,
        e
    ...
    i.RenderTexture = function(t, e, s, n, r, o, a, h) {
        ...
        this.valid = !0,
        this.tempMatrix = new i.Matrix,
        this._updateUvs()
    }
    ,
    i.RenderTexture.prototype = Object.create(PIXI.Texture.prototype),
    i.RenderTexture.prototype.constructor = i.RenderTexture,
    i.RenderTexture.prototype.renderXY = function(t, e, s, n) {
        t.updateTransform(),
        this._tempMatrix.copyFrom(t.worldTransform),
        this._tempMatrix.tx = e,
        this._tempMatrix.ty = s,
        this.renderer.type === i.WEBGL ? this._renderWebGL(t, this._tempMatrix, n) : this._renderCanvas(t, this._tempMatrix, n)
    }
    ,
    i.RenderTexture.prototype.renderRawXY = function(t, e, s, n) {
        this._tempMatrix.identity().translate(e, s),
        this.renderer.type === i.WEBGL ? this._renderWebGL(t, this._tempMatrix, n) : this._renderCanvas(t, this._tempMatrix, n)
    }
    ,
    i.RenderTexture.prototype.render = function(t, e, s) {
        ...
        this.renderer.type === i.WEBGL ? this._renderWebGL(t, this._tempMatrix, s) : this._renderCanvas(t, this._tempMatrix, s)
    }
    ,
    i.RenderTexture.prototype.resize = function(t, e, s) {
        ...
        this.baseTexture.height = this.height * this.resolution),
        this.renderer.type === i.WEBGL && (this.projection.x = this.width / 2,
        this.projection.y = -this.height / 2),
        this.valid && this.textureBuffer.resize(this.width, this.height))
    }
    ,
    i.RenderTexture.prototype.clear = function() {
        this.valid && (this.renderer.type === i.WEBGL && this.renderer.gl.bindFramebuffer(this.renderer.gl.FRAMEBUFFER, this.textureBuffer.frameBuffer),
    ...
    i.RenderTexture.prototype.getCanvas = function() {
        if (this.renderer.type === i.WEBGL) {
            ...
            t.readPixels(0, 0, e, s, t.RGBA, t.UNSIGNED_BYTE, n),
    ...
    i.Text = function(t, e, s, n, r) {
        ...
        this.canvas = i.CanvasPool.create(this),
        this.context = this.canvas.getContext("2d"),
        this.colors = [],
        this.strokeColors = [],
        this.fontStyles = [],
    ...
    i.Text.prototype.updateText = function() {
        ...
        for (var a = 0; a < o; a++) {
            if (0 === i) {
                ...
                this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? u += this.measureLine(e[a]) : u += this.context.measureText(e[a]).width,
                this.style.wordWrap && (u -= this.context.measureText(" ").width)
            } else {
                var h = e[a].split(/(?:\t)/)
                ...
                if (Array.isArray(i))
                    for (var l = 0, c = 0; c < h.length; c++) {
                        var d = 0;
                        d = this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? this.measureLine(h[c]) : Math.ceil(this.context.measureText(h[c]).width),
                        c > 0 && (l += i[c - 1]),
                        u = l + d
                    }
                else
                    for (c = 0; c < h.length; c++)
                        this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? u += this.measureLine(h[c]) : u += Math.ceil(this.context.measureText(h[c]).width),
                        u += this.game.math.snapToCeil(u, i) - u
            }
            s[a] = Math.ceil(u),
            n = Math.max(n, s[a])
        }
        ...
        var p = r.fontSize + this.style.strokeThickness + this.padding.y
          , f = p * o
          , g = this._lineSpacing;
        g < 0 && Math.abs(g) > p && (g = -p),
        0 !== g && (f += g > 0 ? g * e.length : g * (e.length - 1)),
        ...
        a = 0; a < o; a++)
            m = this.style.strokeThickness / 2,
            y = this.style.strokeThickness / 2 + a * p + r.ascent,
            a > 0 && (y += g * a),
            "right" === this.style.align ? m += n - s[a] : "center" === this.style.align && (m += (n - s[a]) / 2),
            this.autoRound && (m = Math.round(m),
            y = Math.round(y)),
            this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? this.updateLine(e[a], m, y) : (this.style.stroke && this.style.strokeThickness && (this.updateShadow(this.style.shadowStroke),
            0 === i ? this.context.strokeText(e[a], m, y) : this.renderTabLine(e[a], m, y, !1)),
            this.style.fill && (this.updateShadow(this.style.shadowFill),
            0 === i ? this.context.fillText(e[a], m, y) : this.renderTabLine(e[a], m, y, !0)));
        this.updateTexture(),
        this.dirty = !1
    }
    ,
    ...
    i.Text.prototype.determineFontProperties = function(t) {
        ...
        if (!e) {
            ...
            !n.getImageData(0, 0, r, a))
                ...
                e;
            var h, u, l = n.getImageData(0, 0, r, a).data, c = l.length, d = 4 * r, p = 0, f = !1;
            for (h = 0; h < o; h++) {
                for (u = 0; u < d; u += 4)
                    if (255 !== l[p + u]) {
                        f = !0;
    ...
    Object.defineProperty(i.Text.prototype, "align", {
        ...
        set: function(t) {
            (t = t.toLowerCase()) !== this.style.align && (this.style.align = t,
            this.dirty = !0)
        }
    }),
    ...
    Object.defineProperty(i.Text.prototype, "strokeThickness", {
        ...
        set: function(t) {
            t !== this.style.strokeThickness && (this.style.strokeThickness = Number(t),
            this.dirty = !0)
        }
    }),
    ...
    i.Text.fontPropertiesCanvas = document.createElement("canvas"),
    ...
    i.BitmapText.prototype.cleanText = function(t, e) {
        ...
        if (!i)
            return "";
        for (var s = /\r\n|\n\r|\n|\r/g, n = t.replace(s, "\n").split("\n"), r = 0; r < n.length; r++) {
            for (var o = "", a = n[r], h = 0; h < a.length; h++)
                o = i.chars[a.charCodeAt(h)] ? o.concat(a[h]) : o.concat(e);
            n[r] = o
        }
        return n.join("\n")
    }
    ...
    i.BitmapText.prototype.updateText = function() {
        ...
        if (t) {
            ...
            this.textWidth = 0;
            do {
                (l = this.scanLine(t, i, e)).y = n,
                s.push(l),
                l.width > this.textWidth && (this.textWidth = l.width),
                n += t.lineHeight * i,
                e = e.substr(l.text.length + 1)
            } while (!1 === l.end);
            this.textHeight = n;
            for (var r = 0, o = 0, a = this.textWidth * this.anchor.x, h = this.textHeight * this.anchor.y, u = 0; u < s.length; u++) {
                ...
                for (var c = 0; c < l.text.length; c++) {
                    ...
                    f ? f.texture = p.texture : ((f = new PIXI.Sprite(p.texture)).name = l.text[c],
                    this._glyphs.push(f)),
                    f.position.x = l.chars[c] + o - a,
                    f.position.y = l.y + p.yOffset * i - h,
                    f.scale.set(i),
                    f.tint = this.tint,
            ...
            for (u = r; u < this._glyphs.length; u++)
    ...
    Object.defineProperty(i.BitmapText.prototype, "fontSize", {
        ...
        set: function(t) {
            (t = parseInt(t, 10)) !== this._fontSize && t > 0 && (this._fontSize = t,
            this.updateText())
        }
    }),
    ...
    i.TileSprite = function(t, e, s, n, r, o, a) {
        ...
        o = o || null,
        a = a || null,
        PIXI.Sprite.call(this, new PIXI.Texture(i.Cache.DEFAULT.baseTexture), n, r),
    ...
    ,
    i.TileSprite.prototype = Object.create(PIXI.Sprite.prototype),
    ...
    i.TileSprite.prototype._renderCanvas = function(t) {
        if (this.visible && this.renderable && 0 !== this.alpha) {
            ...
            16777215 === this.tint || !this.texture.requiresReTint && this.cachedTint === this.tint || (this.tintedTexture = PIXI.CanvasTinter.getTintedTexture(this, this.tint),
            this.cachedTint = this.tint,
            this.texture.requiresReTint = !1,
            this.refreshTexture = !0),
            this.refreshTexture) {
    ...
    ,
    i.TileSprite.prototype.onTextureUpdate = function() {}
    ,
    i.TileSprite.prototype.generateTilingTexture = function(t) {
        if (this.texture.baseTexture.hasLoaded) {
            ...
            t && (n = i.Math.getNextPowerOfTwo(n),
            r = i.Math.getNextPowerOfTwo(r)),
            this.canvasBuffer ? (this.canvasBuffer.resize(n, r),
            this.tilingTexture.baseTexture.width = n,
            this.tilingTexture.baseTexture.height = r,
            this.tilingTexture.needsUpdate = !0) : (this.canvasBuffer = new PIXI.CanvasBuffer(n,r),
            ...
            this.canvasBuffer.context.drawImage(l, e.crop.x, e.crop.y, e.crop.width, e.crop.height, o, a, h, u),
    ...
    i.TileSprite.prototype.getBounds = function() {
        var t = this._width
          ...
          , w = 1 / 0
          , C = 1 / 0;
        w = x < (w = y < (w = g < (w = p < w ? p : w) ? g : w) ? y : w) ? x : w,
        C = _ < (C = v < (C = m < (C = f < C ? f : C) ? m : C) ? v : C) ? _ : C,
        b = x > (b = y > (b = g > (b = p > b ? p : b) ? g : b) ? y : b) ? x : b,
        T = _ > (T = v > (T = m > (T = f > T ? f : T) ? m : T) ? v : T) ? _ : T;
        var S = this._bounds;
        return S.x = w,
        S.width = b - w,
        S.y = C,
    ...
    i.CanvasPool = {
        create: function(t, e, s) {
            ...
            if (-1 === r) {
                ...
                i.CanvasPool.pool.push(o),
                n = o.canvas
            } else
                i.CanvasPool.pool[r].parent = t,
                n = i.CanvasPool.pool[r].canvas;
        ...
        remove: function(t) {
            for (var e = i.CanvasPool.pool, s = 0; s < e.length; s++)
                e[s].parent === t && (e[s].parent = null,
                e[s].canvas.width = 1,
                e[s].canvas.height = 1)
        },
        removeByCanvas: function(t) {
            for (var e = i.CanvasPool.pool, s = 0; s < e.length; s++)
                e[s].canvas === t && (e[s].parent = null,
                e[s].canvas.width = 1,
                e[s].canvas.height = 1)
        },
        getTotal: function() {
            for (var t = i.CanvasPool.pool, e = 0, s = 0; s < t.length; s++)
                t[s].parent && e++;
            return e
        },
        getFree: function() {
    ...
    i.CanvasPool.pool = [],
    Object.defineProperty(i.CanvasPool, "length", {
        get: function() {
    ...
    i.Device._initialize = function() {
        ...
        !function() {
            ...
            s.iOSVersion = parseInt(RegExp.$1, 10)) : /Linux/.test(t) ? s.linux = !0 : /Mac OS/.test(t) ? s.macOS = !0 : /Windows/.test(t) && (s.windows = !0),
            (/Windows Phone/i.test(t) || /IEMobile/i.test(t)) && (s.android = !1,
            s.iOS = !1,
            s.macOS = !1,
            s.windows = !0,
            s.windowsPhone = !0);
            var e = /Silk/.test(t);
            (s.windows || s.macOS || s.linux && !e || s.chromeOS) && (s.desktop = !0),
            (s.windowsPhone || /Windows NT/i.test(t) && /Touch/i.test(t)) && (s.desktop = !1)
        }(),
        function() {
            var t = navigator.userAgent;
            ...
            s.trident = !0,
            s.tridentVersion = parseInt(RegExp.$1, 10),
            s.ieVersion = parseInt(RegExp.$3, 10)),
            /Silk/.test(t) && (s.silk = !0),
            navigator.standalone && (s.webApp = !0),
            void 0 !== window.cordova && (s.cordova = !0),
            ...
            navigator.isCocoonJS && (s.cocoonJS = !0),
            s.cocoonJS)
                try {
            ...
            void 0 !== window.ejecta && (s.ejecta = !0),
            /Crosswalk/.test(t) && (s.crosswalk = !0)
        }(),
        function() {
            s.audioData = !!window.Audio,
            s.webAudio = !(!window.AudioContext && !window.webkitAudioContext);
            ...
            try {
                ...
                t.canPlayType("audio/mpeg;").replace(/^no$/, "") && (s.mp3 = !0),
                t.canPlayType('audio/wav; codecs="1"').replace(/^no$/, "") && (s.wav = !0),
        ...
        function() {
            ...
            try {
                ...
                s.mp4Video = !0),
                t.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, "") && (s.webmVideo = !0),
        ...
        function() {
            ...
            s.css3D = void 0 !== t && t.length > 0 && "none" !== t
        }(),
        s.pixelRatio = window.devicePixelRatio || 1,
        s.iPhone = -1 !== navigator.userAgent.toLowerCase().indexOf("iphone"),
        s.iPhone4 = 2 === s.pixelRatio && s.iPhone,
        s.iPad = -1 !== navigator.userAgent.toLowerCase().indexOf("ipad"),
        "undefined" != typeof Int8Array ? s.typedArray = !0 : s.typedArray = !1,
        "undefined" != typeof ArrayBuffer && "undefined" != typeof Uint8Array && "undefined" != typeof Uint32Array && (s.littleEndian = t(),
        s.LITTLE_ENDIAN = s.littleEndian),
        s.support32bit = "undefined" != typeof ArrayBuffer && "undefined" != typeof Uint8ClampedArray && "undefined" != typeof Int32Array && null !== s.littleEndian && e(),
        navigator.vibrate = navigator.vibrate || navigator.webkitVibrate || navigator.mozVibrate || navigator.msVibrate,
        navigator.vibrate && (s.vibration = !0),
        function() {
            ...
            s.fileSystem = !!window.requestFileSystem,
            s.webGL = !!window.WebGLRenderingContext,
            s.worker = !!window.Worker,
            s.pointerLock = "pointerLockElement"in document || "mozPointerLockElement"in document || "webkitPointerLockElement"in document,
            s.quirksMode = "CSS1Compat" !== document.compatMode,
            navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia || navigator.oGetUserMedia,
            window.URL = window.URL || window.webkitURL || window.mozURL || window.msURL,
            s.getUserMedia = s.getUserMedia && !!navigator.getUserMedia && !!window.URL,
            s.firefox && s.firefoxVersion < 21 && (s.getUserMedia = !1),
            !s.iOS && (s.ie || s.firefox || s.chrome) && (s.canvasBitBltShift = !0),
        ...
        function() {
            ...
            s.canUseMultiply = "multiply" === e.globalCompositeOperation,
            i.CanvasPool.removeByCanvas(t),
            PIXI.CanvasTinter.tintMethod = s.canUseMultiply ? PIXI.CanvasTinter.tintWithMultiply : PIXI.CanvasTinter.tintWithPerPixel
        }(),
        function() {
        ...
        ("ontouchstart"in document.documentElement || window.navigator.maxTouchPoints && window.navigator.maxTouchPoints >= 1) && (s.touch = !0),
    ...
    i.Canvas = {
        ...
        setImageRenderingCrisp: function(t) {
            for (var e = ["-webkit-optimize-contrast", "-moz-crisp-edges", "crisp-edges", "pixelated"], i = 0; i < e.length; i++)
    ...
    i.Math = {
        ...
        rotateToAngle: function(t, e, s) {
            ...
            t === e ? t : (Math.abs(e - t) <= s || Math.abs(e - t) >= i.Math.PI2 - s ? t = e : (Math.abs(e - t) > Math.PI && (e < t ? e += i.Math.PI2 : e -= i.Math.PI2),
            e > t ? t += s : e < t && (t -= s)),
            t)
        },
        ...
        catmullRomInterpolation: function(t, e) {
            ...
            this.catmullRom(t[(n - 1 + i) % i], t[n], t[(n + 1) % i], t[(n + 2) % i], s - n)) : e < 0 ? t[0] - (this.catmullRom(t[0], t[0], t[1], t[1], -s) - t[0]) : e > 1 ? t[i] - (this.catmullRom(t[i], t[i], t[i - 1], t[i - 1], s - i) - t[i]) : this.catmullRom(t[n ? n - 1 : 0], t[n], t[i < n + 1 ? i : n + 1], t[i < n + 2 ? i : n + 2], s - n)
        },
        ...
        sinCosGenerator: function(t, e, i, s) {
            ...
            void 0 === i && (i = 1),
            void 0 === s && (s = 1);
            for (var n = e, r = i, o = s * Math.PI / t, a = [], h = [], u = 0; u < t; u++)
                n += (r -= n * o) * o,
                a[u] = r,
                h[u] = n;
            return {
    ...
    i.QuadTree.prototype = {
        ...
        retrieve: function(t) {
            ...
            return this.nodes[0] && (e = -1 !== s ? e.concat(this.nodes[s].retrieve(t)) : (e = (e = (e = e.concat(this.nodes[0].retrieve(t))).concat(this.nodes[1].retrieve(t))).concat(this.nodes[2].retrieve(t))).concat(this.nodes[3].retrieve(t))),
            e
        },
        clear: function() {
            this.objects.length = 0;
    ...
    i.Net.prototype = {
        ...
        updateQueryString: function(t, e, i, s) {
            ...
            var n = ""
              , r = new RegExp("([?|&])" + t + "=.*?(&|#|$)(.*)","gi");
            if (r.test(s))
                n = void 0 !== e && null !== e ? s.replace(r, "$1" + t + "=" + e + "$2$3") : s.replace(r, "$1$3").replace(/(&|\?)$/, "");
    ...
    i.TweenManager.prototype = {
        ...
        removeFrom: function(t, e) {
            ...
            if (Array.isArray(t))
                ...
                for (var s = 0, n = t.children.length; s < n; s++)
                    this.removeFrom(t.children[s]);
            else {
                for (s = 0,
                n = this._tweens.length; s < n; s++)
                    t === this._tweens[s].target && this.remove(this._tweens[s]);
                for (s = 0,
                n = this._add.length; s < n; s++)
    ...
    i.Tween.prototype = {
        ...
        start: function(t) {
            if (void 0 === t && (t = 0),
            this.pendingDelete)
                return console.warn("Phaser.Tween.start cannot be called after Tween.stop"),
                this;
            if (null === this.game || null === this.target || 0 === this.timeline.length || this.isRunning)
                return this;
            for (i = 0; i < this.timeline.length; i++)
                for (var e in this.timeline[i].vEnd)
                    this.properties[e] = this.target[e] || 0,
        ...
        update: function(t) {
            ...
            if (e === i.TweenData.COMPLETE) {
                ...
                s = !0) : ++this.current === this.timeline.length && (this.current = 0,
                s = !0),
        ...
        generateData: function(t, e) {
            ...
            for (s = 0; s < this.timeline.length; s++)
                for (var i in this.timeline[s].vEnd)
                    this.properties[i] = this.target[i] || 0,
                    Array.isArray(this.properties[i]) || (this.properties[i] *= 1);
            for (s = 0; s < this.timeline.length; s++)
                this.timeline[s].loadValues();
            for (var s = 0; s < this.timeline.length; s++)
                e = e.concat(this.timeline[s].generateData(t));
            return e
        }
    },
        ...
        update: function(t) {
            ...
            this.running && this._now >= this.nextTick && this._len > 0) {
                for (; this._i < this._len && this.running; ) {
                    ...
                    if (!(this._now >= e.tick) || e.pendingDelete)
                        break;
                    this._newTick = this._now + e.delay - (this._now - e.tick),
                    this._newTick < 0 && (this._newTick = this._now + e.delay),
                    !0 === e.loop ? (e.tick = this._newTick,
                    e.callback.apply(e.callbackContext, e.args)) : e.repeatCount > 0 ? (e.repeatCount--,
                    e.tick = this._newTick,
                    e.callback.apply(e.callbackContext, e.args)) : (this._marked++,
                    e.pendingDelete = !0,
                    e.callback.apply(e.callbackContext, e.args)),
                    this._i++
                }
    ...
    i.Animation.prototype = {
        ...
        update: function() {
            ...
            this._frameDiff -= this._frameSkip * this.delay) : this._frameDiff = 0,
    ...
    i.Animation.generateFrameNames = function(t, e, s, n, r) {
        ...
        if (e < s)
            for (h = e; h <= s; h++)
                a = t + (a = "number" == typeof r ? i.Utils.pad(h.toString(), r, "0", 1) : h.toString()) + n,
                o.push(a);
        else
            for (var h = e; h >= s; h--)
                a = t + (a = "number" == typeof r ? i.Utils.pad(h.toString(), r, "0", 1) : h.toString()) + n,
    ...
    i.AnimationParser = {
        spriteSheet: function(t, e, s, n, r, o, a, h) {
            ...
            void 0 === h && (h = 0);
            var u = e;
            if ("string" == typeof e && (u = t.cache.getImage(e)),
            null === u)
                return null;
            var l = u.width
              , c = u.height;
            ...
            if (h > d || h < -d)
                return console.warn("Phaser.AnimationParser.spriteSheet: skipFrames = " + h.toString() + " is larger than total sprite number " + d.toString()),
                null;
            if (h < 0 && (h = d + h),
            -1 !== r && (d = h + r),
            0 === l || 0 === c || l < s || c < n || 0 === d)
                ...
                null;
            for (var p = new i.FrameData, f = o, g = o, m = 0; m < d; m++)
                p.addFrame(new i.Frame(m,f,g,s,n,"")),
                (f += s + a) + s > l && (f = o,
                g += n + a);
            return p
        },
        ...
        JSONDataPyxel: function(t, e) {
            ...
            1 !== e.layers.length)
                ...
                void console.log(e);
            for (var s = new i.FrameData, n = e.tileheight, r = e.tilewidth, o = e.layers[0].tiles, a = 0; a < o.length; a++)
                s.addFrame(new i.Frame(a,o[a].x,o[a].y,r,n,"frame_" + a)).setTrim(!1);
            return s
        },
        ...
        XMLData: function(t, e) {
            if (e.getElementsByTagName("TextureAtlas")) {
                for (var s, n, r, o, a, h, u, l, c, d, p, f = new i.FrameData, g = e.getElementsByTagName("SubTexture"), m = 0; m < g.length; m++)
                    n = (r = g[m].attributes).name.value,
                    ...
                    l = null,
                    c = null,
                    r.frameX && (l = Math.abs(parseInt(r.frameX.value, 10)),
                    c = Math.abs(parseInt(r.frameY.value, 10)),
                    d = parseInt(r.frameWidth.value, 10),
                    p = parseInt(r.frameHeight.value, 10)),
                    s = f.addFrame(new i.Frame(m,o,a,h,u,n)),
                    null === l && null === c || s.setTrim(!0, h, u, l, c, d, p);
                return f
            }
    ...
    i.Cache.DEFAULT = null,
    i.Cache.DEFAULT_KEY = "__default",
    i.Cache.DEFAULT_SRC = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgAQMAAABJtOi3AAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAABVJREFUeF7NwIEAAAAAgKD9qdeocAMAoAABm3DkcAAAAABJRU5ErkJggg==",
    i.Cache.MISSING = null,
    i.Cache.MISSING_KEY = "__missing",
    i.Cache.MISSING_SRC = "data:image/png;base64,",
    i.Cache.READY_TIMEOUT = 1e3,
    i.Cache.prototype = {
        addCompressedTextureMetaData: function(t, e, s, n) {
            ...
            return o.frameData.addFrame(new i.Frame(0,0,0,r.width,r.height,e)),
        ...
        addImage: function(t, e, s) {
            this.checkImageKey(t) && this.removeImage(t),
            !1 === s.complete && console.warn('Phaser.Cache.addImage: Image "' + t + "\" hasn't been retrieved yet");
            var n = {
                key: t,
                url: e,
                data: s,
            ...
            "__default" === t ? i.Cache.DEFAULT = new PIXI.Texture(n.base) : "__missing" === t && (i.Cache.MISSING = new PIXI.Texture(n.base)),
            n
        },
        ...
        addDefaultImage: function() {
            this.addImageAsync(i.Cache.DEFAULT_KEY, i.Cache.DEFAULT_SRC, function(t) {
                t.base.skipRender = !0,
                i.Cache.DEFAULT = new PIXI.Texture(t.base)
            })
        },
        ...
        addBitmapData: function(t, e, s) {
            return e.key = t,
            void 0 === s && (s = new i.FrameData).addFrame(e.textureFrame),
        ...
        addBitmapFont: function(t, e, s, n, r, o, a) {
            ...
            void 0 === o && (o = 0),
            void 0 === a && (a = 0),
            h.font = "json" === r ? i.LoaderParser.jsonBitmapFont(n, h.base, o, a, !1, this.game.resolution) : i.LoaderParser.xmlBitmapFont(n, h.base, o, a, !1, this.game.resolution),
        ...
        addBitmapFontFromAtlas: function(t, e, s, n, r, o, a) {
            ...
            if (h) {
                ...
                void 0 === a && (a = 0);
                var l;
                "json" === r ? (l = this.getJSON(n),
                u.font = i.LoaderParser.jsonBitmapFont(l, u.base, o, a, h, this.game.resolution)) : (l = this.getXML(n),
                u.font = i.LoaderParser.xmlBitmapFont(l, u.base, o, a, h, this.game.resolution)),
        ...
        _addImages: function() {
            ...
            i.Cache.READY_TIMEOUT > 0 ? setTimeout(function() {
                t.isReady || (console.warn("Phaser.Cache: Still waiting for images after %s ms.", e),
                t._ready())
    ...
    Object.defineProperty(i.Cache.prototype, "isReady", {
        get: function() {
    ...
    i.Loader.prototype = {
        setPreloadSprite: function(t, e) {
            ...
            this.preloadSprite.rect = 0 === e ? new i.Rectangle(0,0,1,t.height) : new i.Rectangle(0,0,t.width,1),
        ...
        addToFileList: function(t, e, i, s, n, r) {
            ...
            if (n && h > -1) {
                ...
                u.loading || u.loaded ? (this._fileList.push(o),
            ...
            if (this.game.renderType === i.WEBGL) {
                ...
                for (n in e)
                    if (n.toUpperCase()in r)
                        return this.addToFileList("texture", t, e[n], void 0, s, ".pvr")
            }
            return e.truecolor && this.addToFileList("image", t, e.truecolor, void 0, s, ".png"),
            this
        },
        images: function(t, e) {
            if (Array.isArray(e))
        ...
        processLoadQueue: function() {
            ...
            for (i = 0; i < this._flightQueue.length; i++)
                ((s = this._flightQueue[i]).loaded || s.error) && (this._flightQueue.splice(i, 1),
                i--,
                s.loading = !1,
                s.requestUrl = null,
            ...
            for (var t = !1, e = this.enableParallel ? Math.max(1, this.maxParallelDownloads) : 1, i = this._processingHead; i < this._fileList.length; i++) {
                ...
                if ("packfile" === s.type && !s.error && s.loaded && i === this._processingHead && (this.processPack(s),
                this._loadedPackCount++,
                this.onPackComplete.dispatch(s.key, !s.error, this._loadedPackCount, this._totalPackCount)),
                s.loaded || s.error ? i === this._processingHead && (this._processingHead = i + 1) : !s.loading && this._flightQueue.length < e && ("packfile" !== s.type || s.data ? t || (this._fileLoadStarted || (this._fileLoadStarted = !0,
                ...
                s.loading = !0,
                this.loadFile(s))),
                !s.loaded && s.syncPoint && (t = !0),
                this._flightQueue.length >= e || t && this._loadedPackCount === this._totalPackCount)
                    break
            }
        ...
        finishedLoading: function(t) {
            ...
            this.game.state && this.game.state.loadComplete())
        },
    ...
    i.LoaderParser = {
        ...
        pvr: function(t) {
            ...
            if (55727696 === i[0] && [0, 1, 2, 3, 6, 7, 9, 11].indexOf(r) >= 0) {
                switch (r >= 0 && r <= 3 ? e = "PVRTC" : r >= 7 && r <= 11 ? e = "S3TC" : 6 === r && (e = "ETC1"),
                r) {
                case 0:
                    o = 35841;
                    break;
    ...
    i.Sound.prototype = {
        ...
        onEndedHandler: function() {
            ...
            this.stop(),
            this.playOnce && (this._markedToDelete = !0,
            this._removeFromSoundManager = !0),
        ...
        play: function(t, e, i, s, n) {
            ...
            this.stopTime = this.startTime + this.durationMS,
            this.onPlay.dispatch(this)) : this.pendingPlayback = !0,
            this.playOnce && (this.loop && console.warn("Phaser.Sound.play: audio clip " + this.name + " cannot be deleted while looping."),
        ...
        updateGlobalVolume: function(t) {
            this.usingAudioTag && this._sound && (this._globalVolume = t,
    ...
    Object.defineProperty(i.Sound.prototype, "volume", {
        ...
        set: function(t) {
            ...
            this._volume = t,
            this.usingWebAudio ? this.gainNode.gain.value = t : this.usingAudioTag && this._sound && (this._sound.volume = this._globalVolume * t))
        }
    }),
    i.SoundManager = function(t) {
        ...
        this.onTouchUnlock = new i.Signal,
        this.context = null,
    ...
    i.SoundManager.prototype = {
        boot: function() {
            ...
            if (t.iOS && !1 === t.webAudio && (this.channels = 1),
            e) {
                if (!0 === e.disableAudio)
                    return this.noAudio = !0,
                    void (this.touchLocked = !1);
                if (!0 === e.disableWebAudio)
                    return this.usingAudioTag = !0,
                    void (this.touchLocked = !1)
            }
            if (e && e.audioContext)
                this.context = e.audioContext;
    ...
    i.ScaleManager.MODES = ["EXACT_FIT", "NO_SCALE", "SHOW_ALL", "RESIZE", "USER_SCALE"],
    i.ScaleManager.prototype = {
        ...
        forceOrientation: function(t, e) {
            void 0 === e && (e = !1),
            !0 !== t || !0 !== e ? (this.forceLandscape = t,
            this.forcePortrait = e,
            this.queueUpdate(!0)) : console.warn("Phaser.ScaleManager: forceLandscape and forcePortrait cannot both be true.")
        },
        ...
        alignCanvas: function(t, e) {
            ...
            if (t) {
                ...
                0 !== n.left && (n.right = -(i.width - h.width - n.left),
            ...
            if (e) {
                ...
                0 !== n.top && (n.bottom = -(i.height - h.height - n.top),
                ...
                return !1;
            {
                if (this.compatibility.supportsFullScreen) {
                    if ("when-not-mouse" === this.compatibility.clickTrampoline) {
                        var s = this.game.input;
                        if (s.activePointer && s.activePointer !== s.mousePointer && (e || !1 !== e))
                            return void s.activePointer.addClickTrampoline("startFullScreen", this.startFullScreen, this, [t, !1])
                    }
                    void 0 !== t && this.game.renderType === i.CANVAS && (this.game.stage.smoothed = t);
                    var n = this.fullScreenTarget;
                    n || (this.cleanupCreatedTarget(),
    ...
    i.Utils.Debug.prototype = {
        boot: function() {
            this.game.renderType === i.CANVAS ? this.context = this.game.context : (this.bmd = new i.BitmapData(this.game,"__DEBUG",this.game.width,this.game.height,!0),
            this.sprite = this.game.make.image(0, 0, this.bmd),
            this.game.stage.addChild(this.sprite),
            this.game.scale.onSizeChange.add(this.resize, this),
            this.canvas = i.CanvasPool.create(this, this.game.width, this.game.height),
            this.context = this.canvas.getContext("2d")),
            this._line = new i.Line,
            this._rect = new i.Rectangle
        },
        resize: function() {
        ...
        sound: function(t, e, i) {
            ...
            this.start(t, e, i),
            s.noAudio ? this.line("Audio is disabled") : (this.line("Volume: " + s.volume.toFixed(2) + (s.mute ? " (Mute)" : "")),
            this.line("Mute on pause: " + s.muteOnPause),
            this.line("Using: " + (s.usingWebAudio ? "Web Audio - " + s.context.state : "Audio Tag")),
            this.line("Touch locked: " + s.touchLocked),
            this.line("Sounds: " + s._sounds.length)),
            this.stop()
        },
        soundInfo: function(t, e, i, s) {
            ...
            this.line("Time: " + t.currentTime + "ms Total: " + t.totalDuration.toFixed(3) + "s"),
            this.line("Volume: " + t.volume.toFixed(2) + (t.mute ? " (Mute)" : "")),
            this.line("Using: " + (t.usingWebAudio ? "Web Audio" : "Audio Tag")),
        ...
        camera: function(t, e, i) {
            var s = t.deadzone
              , n = t.target
              , r = t.view;
            s && (this._rect.setTo(r.x + s.x, r.y + s.y, s.width, s.height),
            this.rectangle(this._rect, e, i)),
            n && (this._line.setTo(r.centerX, r.centerY, n.x, n.y),
            this.geom(this._line, e, i),
            this.geom(n, e, !1, 3))
        },
        ...
        geom: function(t, e, s, n) {
            ...
            this.context.closePath(),
            s ? this.context.fill() : this.context.stroke()) : t instanceof i.Point || 3 === n ? this.context.fillRect(t.x - this.game.camera.x, t.y - this.game.camera.y, 4, 4) : t instanceof i.Line || 4 === n ? (this.context.beginPath(),
            ...
            this.context.closePath(),
            this.context.stroke()) : (t instanceof i.Ellipse || 5 === n) && (this.context.beginPath(),
            this.context.ellipse(t.x - this.game.camera.x, t.y - this.game.camera.y, t.width / 2, t.height / 2, 0, 2 * Math.PI, !1),
            this.context.closePath(),
            s ? this.context.fill() : this.context.stroke()),
            this.stop()
        },
        ...
        body: function(t, e, s) {
            t.body && (this.start(),
            t.body.type === i.Physics.ARCADE ? i.Physics.Arcade.Body.render(this.context, t.body, e, s, this.lineWidth) : t.body.type === i.Physics.NINJA ? i.Physics.Ninja.Body.render(this.context, t.body, e, s) : t.body.type === i.Physics.BOX2D && i.Physics.Box2D.renderBody(this.context, t.body, e),
            this.stop())
        },
        ...
        renderer: function(t, e, i) {
            var s = this.game.renderer
              , n = s.renderSession;
            if (this.start(t, e, i),
            this.line((s.gl ? "WebGL" : "Canvas") + " Renderer (" + s.width + " x " + s.height + ")"),
            this.line("autoResize: " + s.autoResize),
            this.line("clearBeforeRender: " + s.clearBeforeRender),
            this.line("resolution: " + s.resolution),
            this.line("transparent: " + s.transparent),
            this.line("renderSession:"),
            s.gl) {
                this.line("  currentBatchedTextures: (" + s.currentBatchedTextures.length + ")");
                for (var r = 0; r < s.currentBatchedTextures.length; r++)
                    this.line("    " + s.currentBatchedTextures[r]);
        ...
        scale: function(t, e, s) {
            ...
            var n = this.game.scale
              ...
              , o = n._parentBounds
              , t = " x ";
            this.line("Game: " + this.game.width + t + this.game.height),
            this.line("Canvas: " + n.width + t + n.height + " (" + r.x.toFixed(2) + t + r.y.toFixed(2) + ") [" + n.aspectRatio.toFixed(2) + "]"),
            this.line("Mode: " + i.ScaleManager.MODES[n.currentScaleMode] + (n.currentScaleMode === i.ScaleManager.USER_SCALE ? " (" + n._userScaleFactor.x + t + n._userScaleFactor.y + ")" : "")),
        ...
        loader: function(t, e, s, n) {
            var r = i.Utils.pad;
            this.start(e, s, n),
            t.hasLoaded ? this.line("Complete" + (t.resetLocked ? " [locked]" : "")) : t.isLoading ? this.line("Loading") : this.line("Not started"),
            t.hasLoaded && !t.resetLocked || (this.line("Progress: " + r(t.progress, 3) + "%"),
            this.line("Files: " + t._loadedFileCount + " of " + t._totalFileCount),
            this.line("Packs: " + t._loadedPackCount + " of " + t._loadedPackCount)),
            this.stop()
        },
        destroy: function() {
            i.CanvasPool.remove(this)
    ...
    i.ArrayUtils = {
        ...
        rotateMatrix: function(t, e) {
            ...
            90 === e || -270 === e || "rotateLeft" === e)
                t = (t = i.ArrayUtils.transposeMatrix(t)).reverse();
        ...
        numberArrayStep: function(t, e, s) {
            ...
            t = 0),
            void 0 === s && (s = 1);
            for (var n = [], r = Math.max(i.Math.roundAwayFromZero((e - t) / (s || 1)), 0), o = 0; o < r; o++)
                n.push(t),
                t += s;
            return n
        }
    ...
    i.Create.prototype = {
        texture: function(t, e, i, s, n, r, o, a) {
            ...
            for (var l = 0; l < e.length; l++)
                for (var c = e[l], d = 0; d < c.length; d++) {
                    var p = c[d];
                    "." !== p && " " !== p && (this.ctx.fillStyle = this.palettes[n][p],
                    this.ctx.fillRect(d * i, l * s, i, s))
                }
        ...
        grid: function(t, e, i, s, n, r, o, a, h) {
            ...
            for (var u = 0; u < i; u += n)
                this.ctx.fillRect(0, u, e, 1);
            for (var l = 0; l < e; l += s)
                this.ctx.fillRect(l, 0, 1, i);
    ...
    i.FlexGrid.prototype = {
        ...
        createCustomLayer: function(t, e, s, n) {
            ...
            this.layers.push(r),
            void 0 !== s && null !== typeof s && r.addMultiple(s),
            r
        },
        createFluidLayer: function(t, e) {
            ...
            this.layers.push(s),
            void 0 !== t && null !== typeof t && s.addMultiple(t),
            s
        },
    ...
    i.Color = {
        ...
        RGBtoHSL: function(t, e, s, n) {
            ...
            o !== r) {
                ...
                o === t ? n.h = (e - s) / a + (e < s ? 6 : 0) : o === e ? n.h = (s - t) / a + 2 : o === s && (n.h = (t - e) / a + 4),
                n.h /= 6
            }
            return n
        },
        ...
        RGBtoHSV: function(t, e, s, n) {
            ...
            n.s = 0 === o ? 0 : a / o,
            n.v = o,
            o !== r && (o === t ? n.h = (e - s) / a + (e < s ? 6 : 0) : o === e ? n.h = (s - t) / a + 2 : o === s && (n.h = (t - e) / a + 4),
            n.h /= 6),
            n
        },
        HSVtoRGB: function(t, e, s, n) {
            void 0 === n && (n = i.Color.createColor(0, 0, 0, 1, t, e, 0, s));
            var r, o, a, h = Math.floor(6 * t), u = 6 * t - h, l = s * (1 - e), c = s * (1 - u * e), d = s * (1 - (1 - u) * e);
            switch (h % 6) {
            case 0:
                r = s,
                o = d,
        ...
        updateColor: function(t) {
            ...
            t.color32 = i.Color.getColor32(255 * t.a, t.r, t.g, t.b),
            t
        },
        ...
        hexToRGB: function(t) {
            ...
            if (e)
                return i.Color.getColor32(e.a, e.r, e.g, e.b)
        },
        ...
        webToColor: function(t, e) {
            ...
            return s && (e.r = ~~Number(s[1]),
            e.g = ~~Number(s[2]),
            e.b = ~~Number(s[3]),
            e.a = void 0 !== s[4] ? Number(s[4]) : 1,
        ...
        interpolateColor: function(t, e, s, n, r, o) {
            ...
            var a = i.Color.getRGB(t)
              , h = i.Color.getRGB(e);
            if (0 === o)
                var u = (h.red - a.red) * n / s + a.red
                  , l = (h.green - a.green) * n / s + a.green
                  , c = (h.blue - a.blue) * n / s + a.blue;
            if (1 === o) {
                var d, p = i.Color.RGBtoHSV(a.r, a.g, a.b), f = i.Color.RGBtoHSV(h.r, h.g, h.b), g = f.h - p.h;
                if (p.h > f.h) {
                    var m = f.h;
                    f.h = p.h,
                    p.h = m,
    ...
    i.Physics.prototype = {
        parseConfig: function() {
            this.config.hasOwnProperty("arcade") && !0 !== this.config.arcade || !i.Physics.hasOwnProperty("Arcade") || (this.arcade = new i.Physics.Arcade(this.game)),
            this.config.hasOwnProperty("ninja") && !0 === this.config.ninja && i.Physics.hasOwnProperty("Ninja") && (this.ninja = new i.Physics.Ninja(this.game)),
            this.config.hasOwnProperty("p2") && !0 === this.config.p2 && i.Physics.hasOwnProperty("P2") && (this.p2 = new i.Physics.P2(this.game,this.config)),
            this.config.hasOwnProperty("box2d") && !0 === this.config.box2d && i.Physics.hasOwnProperty("BOX2D") && (this.box2d = new i.Physics.BOX2D(this.game,this.config)),
            this.config.hasOwnProperty("matter") && !0 === this.config.matter && i.Physics.hasOwnProperty("Matter") && (this.matter = new i.Physics.Matter(this.game,this.config))
        },
    ...
    void 0 === PIXI.DisplayObject._tempMatrix && (PIXI.DisplayObject._tempMatrix = new i.Matrix),
    ...
    exports.Phaser = i) : "undefined" != typeof define && define.amd ? define("Phaser", e.Phaser = i) : e.Phaser = i,
    i
}
.call(this);
