...
!(function (t, e) {
    ...
    function M(t, e) {
        ...
        return (
            (n.aria = Object.assign({}, R.aria, n.aria)), (n.aria = { expanded: "auto" === n.aria.expanded ? e.interactive : n.aria.expanded, content: "auto" === n.aria.content ? (e.interactive ? null : "describedby") : n.aria.content }), n
        );
    }
    function V(t, e) {
        t.innerHTML = e;
  ...
  setTimeout(() => { 
      ...
      console.log("font-family: arial; color: white; text-shadow: 1px 1px #171717; border: 1px solid #171717; font-weight: 600; background: #171717; padding: 5px 10px; border-radius: 10px;", "Loaded Successfully!");
      SnackBar({
        message: "Game Loaded!",
        theme: 'darker',
        position: "br",
